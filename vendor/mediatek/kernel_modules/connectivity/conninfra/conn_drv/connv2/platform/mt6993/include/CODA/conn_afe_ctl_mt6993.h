 ...
 */
//[File]            : conn_afe_ctl.h
//[Revision time]   : Wed Oct 30 15:12:39 2024
...
#define CONN_AFE_CTL_BASE                                      (CONN_AFE_CTL_BASE_ADDR_MT6993) // 0x40041000
...
/* =====================================================================================
  ...
  ---RG_WBG_AFE_01 (0x18041000 + 0x010)---
    ...
    RG_TST_PAD_EN[15]            - (RW) Enable TST PAD                                                              0:Disable                                                                       1:Enable
    RG_WBG_AFE_RSV1[24..16]      - (RW) RSV
...
#define CONN_AFE_CTL_RG_WBG_AFE_01_RG_WBG_AFE_RSV1_MASK        0x01FF0000                // RG_WBG_AFE_RSV1[24..16]
#define CONN_AFE_CTL_RG_WBG_AFE_01_RG_WBG_AFE_RSV1_SHFT        16
#define CONN_AFE_CTL_RG_WBG_AFE_01_RG_TST_PAD_EN_ADDR          CONN_AFE_CTL_RG_WBG_AFE_01_ADDR
#define CONN_AFE_CTL_RG_WBG_AFE_01_RG_TST_PAD_EN_MASK          0x00008000                // RG_TST_PAD_EN[15]
#define CONN_AFE_CTL_RG_WBG_AFE_01_RG_TST_PAD_EN_SHFT          15
...
/* =====================================================================================
  ...
  ---RG_WBG_AFE_03 (0x18041000 + 0x018)---
    ...
    RG_WBG_CLKSQ_CK2BWPLL_EN_force[1] - (RW) Force enable CK2BWPLL at manual mode
                                     1'b0: Disable
                                     1'b1: Enable
    RG_RSV[2]                    - (RW) Reserved
    RG_WBG_CLKSQ_MONDC_EN[3]     - (RW) monitor CLKSQ_LDO Voltage for debug
                                     1'b00: Disable
                                     1'b1: CLKSQ_LDO
    RG_WBG_CLKSQ_MONCK_EN[5..4]  - (RW) Enable monitor CLKSQ clock for debug
                                     2'b00: Disable
                                     2'b01: Ref. clock
                                     2'b10: Red. Clock rising (/2)
                                     2'b11: Red. Clock falling (/2)
...
#define CONN_AFE_CTL_RG_WBG_AFE_03_RG_WBG_CLKSQ_MONCK_EN_MASK  0x00000030                // RG_WBG_CLKSQ_MONCK_EN[5..4]
#define CONN_AFE_CTL_RG_WBG_AFE_03_RG_WBG_CLKSQ_MONCK_EN_SHFT  4
#define CONN_AFE_CTL_RG_WBG_AFE_03_RG_WBG_CLKSQ_MONDC_EN_ADDR  CONN_AFE_CTL_RG_WBG_AFE_03_ADDR
#define CONN_AFE_CTL_RG_WBG_AFE_03_RG_WBG_CLKSQ_MONDC_EN_MASK  0x00000008                // RG_WBG_CLKSQ_MONDC_EN[3]
#define CONN_AFE_CTL_RG_WBG_AFE_03_RG_WBG_CLKSQ_MONDC_EN_SHFT  3
#define CONN_AFE_CTL_RG_WBG_AFE_03_RG_RSV_ADDR                 CONN_AFE_CTL_RG_WBG_AFE_03_ADDR
#define CONN_AFE_CTL_RG_WBG_AFE_03_RG_RSV_MASK                 0x00000004                // RG_RSV[2]
#define CONN_AFE_CTL_RG_WBG_AFE_03_RG_RSV_SHFT                 2
...
/* =====================================================================================
  ...
  ---RG_WBG_PLL_07 (0x18041000 + 0x03C)---
    ...
    RG_BPLL_DIG_LOAD_EN[8]       - (RW) Enable load IBAND
                                     1'b0: Disable
                                     1'b1: Enable
    RG_BPLL_OPEN_LOOP_ENB[9]     - (RW) PLL open loop
                                     1'b0 : LPF_EN = 0
                                     1'b1 : normal mode
    RG_BPLL_KBAND_KFC_MSB[10]    - (RW) Modify delay from FC2_EN to LPF_EN
                                     original : 2'b01
                                     Liber : RG_MSB + TIEH
    ...
    RG_LPLL_DIG_LOAD_EN[19]      - (RW) Enable load IBAND
                                     1'b0: Disable
                                     1'b1: Enable
    RG_LPLL_OPEN_LOOP_ENB[20]    - (RW) PLL open loop
                                     1'b0 : LPF_EN = 0
                                     1'b1 : normal mode
    RG_LPLL_KBAND_KFC_MSB[21]    - (RW) Modify delay from FC2_EN to LPF_EN
                                     original : 2'b01
                                     Liber : RG_MSB + TIEH
    RG_BLPLL_KBAND_CLK_ENB[22]   - (RW) Disable Kband clock
                                     0:original mode
                                     1:disable Kband clock
...
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_BLPLL_KBAND_CLK_ENB_ADDR CONN_AFE_CTL_RG_WBG_PLL_07_ADDR
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_BLPLL_KBAND_CLK_ENB_MASK 0x00400000                // RG_BLPLL_KBAND_CLK_ENB[22]
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_BLPLL_KBAND_CLK_ENB_SHFT 22
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_LPLL_KBAND_KFC_MSB_ADDR  CONN_AFE_CTL_RG_WBG_PLL_07_ADDR
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_LPLL_KBAND_KFC_MSB_MASK  0x00200000                // RG_LPLL_KBAND_KFC_MSB[21]
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_LPLL_KBAND_KFC_MSB_SHFT  21
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_LPLL_OPEN_LOOP_ENB_ADDR  CONN_AFE_CTL_RG_WBG_PLL_07_ADDR
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_LPLL_OPEN_LOOP_ENB_MASK  0x00100000                // RG_LPLL_OPEN_LOOP_ENB[20]
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_LPLL_OPEN_LOOP_ENB_SHFT  20
...
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_BPLL_KBAND_KFC_MSB_ADDR  CONN_AFE_CTL_RG_WBG_PLL_07_ADDR
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_BPLL_KBAND_KFC_MSB_MASK  0x00000400                // RG_BPLL_KBAND_KFC_MSB[10]
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_BPLL_KBAND_KFC_MSB_SHFT  10
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_BPLL_OPEN_LOOP_ENB_ADDR  CONN_AFE_CTL_RG_WBG_PLL_07_ADDR
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_BPLL_OPEN_LOOP_ENB_MASK  0x00000200                // RG_BPLL_OPEN_LOOP_ENB[9]
#define CONN_AFE_CTL_RG_WBG_PLL_07_RG_BPLL_OPEN_LOOP_ENB_SHFT  9
...
/* =====================================================================================
  ...
  ---RG_WBG_GL1_02 (0x18041000 + 0x044)---
    ...
    RG_GL1_02_RSV1[5..0]         - (RW)  xxx 
    RG_MUX_TIEL[6]               - (RW) MUX_TIEL
                                     0 : Off(POR)
                                     1 : On
    RG_AOUT_TST[7]               - (RW) AOUT_TST
                                     0 : Off(POR)
                                     1 : On
...
#define CONN_AFE_CTL_RG_WBG_GL1_02_RG_AOUT_TST_ADDR            CONN_AFE_CTL_RG_WBG_GL1_02_ADDR
#define CONN_AFE_CTL_RG_WBG_GL1_02_RG_AOUT_TST_MASK            0x00000080                // RG_AOUT_TST[7]
#define CONN_AFE_CTL_RG_WBG_GL1_02_RG_AOUT_TST_SHFT            7
#define CONN_AFE_CTL_RG_WBG_GL1_02_RG_MUX_TIEL_ADDR            CONN_AFE_CTL_RG_WBG_GL1_02_ADDR
#define CONN_AFE_CTL_RG_WBG_GL1_02_RG_MUX_TIEL_MASK            0x00000040                // RG_MUX_TIEL[6]
#define CONN_AFE_CTL_RG_WBG_GL1_02_RG_MUX_TIEL_SHFT            6
#define CONN_AFE_CTL_RG_WBG_GL1_02_RG_GL1_02_RSV1_ADDR         CONN_AFE_CTL_RG_WBG_GL1_02_ADDR
#define CONN_AFE_CTL_RG_WBG_GL1_02_RG_GL1_02_RSV1_MASK         0x0000003F                // RG_GL1_02_RSV1[5..0]
...
/* =====================================================================================
  ...
  ---RG_WBG_AFE_CRC (0x18041000 + 0x0164)---
    ...
    ro_wbg_afe_crc_done[22]      - (RO) 0: CRC calibration not done
                                     1: CRC calibration done (4096 cycles)
    ro_wbg_afe_crc_err[23]       - (RO) 0: CRC calibration doesn't have error
                                     1: CRC calibration has error
    ro_wbg_afe_crc_nearby_err[24] - (RO) 0: No error
                                     1: CRC calibration receive same value between two samples
    ro_wbg_afe_crc[31..25]       - (RO) Reserved

 =====================================================================================*/
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_ADDR        CONN_AFE_CTL_RG_WBG_AFE_CRC_ADDR
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_MASK        0xFE000000                // ro_wbg_afe_crc[31..25]
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_SHFT        25
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_nearby_err_ADDR CONN_AFE_CTL_RG_WBG_AFE_CRC_ADDR
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_nearby_err_MASK 0x01000000                // ro_wbg_afe_crc_nearby_err[24]
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_nearby_err_SHFT 24
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_err_ADDR    CONN_AFE_CTL_RG_WBG_AFE_CRC_ADDR
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_err_MASK    0x00800000                // ro_wbg_afe_crc_err[23]
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_err_SHFT    23
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_done_ADDR   CONN_AFE_CTL_RG_WBG_AFE_CRC_ADDR
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_done_MASK   0x00400000                // ro_wbg_afe_crc_done[22]
#define CONN_AFE_CTL_RG_WBG_AFE_CRC_ro_wbg_afe_crc_done_SHFT   22
