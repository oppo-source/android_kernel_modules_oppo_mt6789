 ...
 */
struct consys_platform_emi_ops g_consys_platform_emi_ops_mt6993 = {
	.consys_ic_emi_mpu_set_region_protection = NULL,
	.consys_ic_emi_set_remapping_reg = consys_emi_set_remapping_reg_mt6993_atf,
	.consys_ic_emi_get_md_shared_emi = NULL,
};

unsigned int consys_emi_set_remapping_reg_mt6993_atf(
	...
	phys_addr_t gps_emi_base_addr)
{
	...
	CONNSYS_SMC_CALL_RET(SMC_CONNSYS_EMI_SET_REMAPPING_REG_OPID,
			     CONN_HW_VER_MT6993, CONNSYS_A_DIE_ID_MT6993,
			     0, 0, 0, 0, ret);
#endif
	return ret;
}
