...
#define CONN_HOST_CSR_TOP_CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR_ADDR (CONN_HOST_CSR_TOP_BASE + 0x324) // 0324
...
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_ADDR (CONN_HOST_CSR_TOP_BASE + 0x400) // 0400
...
/* =====================================================================================
  ...
  ---CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR (0x18060000 + 0x324)---

    CR_CSR_CONN2EMI_TX_SLP_PROT_DIS[0] - (RW) force enable sleep protect for conn2emi tx
    CR_CSR_CONN2EMI_TX_SLP_PROT_EN[1] - (RW) force disable sleep protect for conn2emi tx
    RESERVED2[31..2]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR_CR_CSR_CONN2EMI_TX_SLP_PROT_EN_ADDR CONN_HOST_CSR_TOP_CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR_ADDR
#define CONN_HOST_CSR_TOP_CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR_CR_CSR_CONN2EMI_TX_SLP_PROT_EN_MASK 0x00000002                // CR_CSR_CONN2EMI_TX_SLP_PROT_EN[1]
#define CONN_HOST_CSR_TOP_CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR_CR_CSR_CONN2EMI_TX_SLP_PROT_EN_SHFT 1
#define CONN_HOST_CSR_TOP_CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR_CR_CSR_CONN2EMI_TX_SLP_PROT_DIS_ADDR CONN_HOST_CSR_TOP_CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR_ADDR
#define CONN_HOST_CSR_TOP_CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR_CR_CSR_CONN2EMI_TX_SLP_PROT_DIS_MASK 0x00000001                // CR_CSR_CONN2EMI_TX_SLP_PROT_DIS[0]
#define CONN_HOST_CSR_TOP_CONN_CONN2EMI_TX_SLEEP_PROTECT_CTRL_CSR_CR_CSR_CONN2EMI_TX_SLP_PROT_DIS_SHFT 0
...
/* =====================================================================================
  ...
  ---CONN_INFRA_AXI_LAYER_SLPPROT_STA (0x18060000 + 0x400)---

    CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_RDY[1..0] - (RO)  xxx 
    CONN2INFRA_MEM_GLAS_TX_SLPPROT_RDY[2] - (RO)  xxx 
    CONN2INFRA_IO_GLAS_TX_SLPPROT_RDY[3] - (RO)  xxx 
    CONN2INFRA_MEM_GLAS_RX_SLPPROT_RDY[4] - (RO)  xxx 
    CONN2INFRA_IO_GLAS_RX_SLPPROT_RDY[5] - (RO)  xxx 
    CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_EN[7..6] - (RO)  xxx 
    CONN2INFRA_MEM_GALS_TX_SLPPROT_EN_POST[8] - (RO)  xxx 
    CONN2INFRA_IO_GLAS_TX_SLPPROT_EN_POST[9] - (RO)  xxx 
    RESERVED10[31..10]           - (RO) Reserved bits

 =====================================================================================*/
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_IO_GLAS_TX_SLPPROT_EN_POST_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_IO_GLAS_TX_SLPPROT_EN_POST_MASK 0x00000200                // CONN2INFRA_IO_GLAS_TX_SLPPROT_EN_POST[9]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_IO_GLAS_TX_SLPPROT_EN_POST_SHFT 9
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_MEM_GALS_TX_SLPPROT_EN_POST_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_MEM_GALS_TX_SLPPROT_EN_POST_MASK 0x00000100                // CONN2INFRA_MEM_GALS_TX_SLPPROT_EN_POST[8]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_MEM_GALS_TX_SLPPROT_EN_POST_SHFT 8
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_EN_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_EN_MASK 0x000000C0                // CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_EN[7..6]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_EN_SHFT 6
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_IO_GLAS_RX_SLPPROT_RDY_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_IO_GLAS_RX_SLPPROT_RDY_MASK 0x00000020                // CONN2INFRA_IO_GLAS_RX_SLPPROT_RDY[5]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_IO_GLAS_RX_SLPPROT_RDY_SHFT 5
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_MEM_GLAS_RX_SLPPROT_RDY_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_MEM_GLAS_RX_SLPPROT_RDY_MASK 0x00000010                // CONN2INFRA_MEM_GLAS_RX_SLPPROT_RDY[4]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_MEM_GLAS_RX_SLPPROT_RDY_SHFT 4
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_IO_GLAS_TX_SLPPROT_RDY_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_IO_GLAS_TX_SLPPROT_RDY_MASK 0x00000008                // CONN2INFRA_IO_GLAS_TX_SLPPROT_RDY[3]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_IO_GLAS_TX_SLPPROT_RDY_SHFT 3
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_MEM_GLAS_TX_SLPPROT_RDY_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_MEM_GLAS_TX_SLPPROT_RDY_MASK 0x00000004                // CONN2INFRA_MEM_GLAS_TX_SLPPROT_RDY[2]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN2INFRA_MEM_GLAS_TX_SLPPROT_RDY_SHFT 2
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_RDY_ADDR CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_ADDR
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_RDY_MASK 0x00000003                // CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_RDY[1..0]
#define CONN_HOST_CSR_TOP_CONN_INFRA_AXI_LAYER_SLPPROT_STA_CONN_WLA_MASTER_W_HRT_THROTTLE_BUS_PROT_RDY_SHFT 0
