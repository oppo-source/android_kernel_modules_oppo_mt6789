...
#ifndef _PLATFORM_MT6993_CONSYS_REG_OFFSET_H_
#define _PLATFORM_MT6993_CONSYS_REG_OFFSET_H_

#include "mt6993_consys_reg.h"

#define INFRABUS_AO_REG_BASE_ADDR (INFRABUS_AO_REG_BASE_ADDR_MT6993)
#define SPM_BASE_ADDR             (SPM_BASE_ADDR_MT6993)
 ...
 * Size:
 *********************************************************************/
#include "conn_bus_cr_on_mt6993.h"
 ...
 * Size:
 ********************************************************************/
#include "conn_cfg_mt6993.h"
#define CONN_HW_VER	0x2050800
 ...
 * Size:
 *********************************************************************/
#include "conn_clkgen_top_mt6993.h"
 ...
 * Size:
 *********************************************************************/
#include "conn_host_csr_top_mt6993.h"
 ...
 * Size:
 *********************************************************************/
#include "conn_off_debug_ctrl_ao_mt6993.h"
 ...
 * Size:
 *********************************************************************/
#include "conn_rf_spi_mst_reg_mt6993.h"
 ...
 * Size:
 *********************************************************************/
#include "conn_semaphore_mt6993.h"
 ...
 * Size:
 *********************************************************************/
#include "conn_wt_slp_ctl_reg_mt6993.h"
...
#define CONN_INFRA_SYSRAM_BASE                  (CONN_INFRA_SYSRAM_BASE_ADDR_MT6993)
#define CONN_INFRA_SYSRAM_SW_CR_BASE            (CONN_INFRA_SYSRAM_BASE_ADDR_MT6993 + 4*1024)
 ...
 * Size:
 *********************************************************************/
#include "conn_dbg_ctl_mt6993.h"

/**********************************************************************
 * Misc
 *********************************************************************/
#define REG_SRCLKENRC_BASE        (VLPSYS_SRCLKENRC_MT6993)
...
#endif /* _PLATFORM_MT6993_CONSYS_REG_OFFSET_H_ */
