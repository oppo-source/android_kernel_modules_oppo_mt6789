...
static int consys_plt_pmic_common_power_low_power_mode_mt6991(unsigned int enable,
					unsigned int curr_status, unsigned int next_status);
static int consys_plt_pmic_get_from_dts_mt6991_6661(struct platform_device*, struct conninfra_dev_cb*);
static int consys_plt_pmic_common_power_low_power_mode_mt6991_6661(unsigned int enable,
					unsigned int curr_status, unsigned int next_status);
...
const struct consys_platform_pmic_ops g_consys_platform_pmic_ops_mt6991_6661 = {
	.consys_pmic_get_from_dts = consys_plt_pmic_get_from_dts_mt6991_6661,
	.consys_pmic_common_power_ctrl = consys_plt_pmic_common_power_ctrl_mt6991,
	.consys_pmic_common_power_low_power_mode = consys_plt_pmic_common_power_low_power_mode_mt6991_6661,
};
...
static int consys_plt_pmic_get_from_dts_mt6991_6661(struct platform_device* pdev, struct conninfra_dev_cb* cb)
{
