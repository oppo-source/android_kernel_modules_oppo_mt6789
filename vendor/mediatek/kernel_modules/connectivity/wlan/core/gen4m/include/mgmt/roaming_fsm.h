...
static uint8_t apucRoamingReasonConvert[ROAMING_REASON_NUM] = {
	ROAMING_REPORT_REASON_POOR_RSSI,		/* map to ROAMING_REASON_POOR_RCPI(0) */
	ROAMING_REPORT_REASON_TX_ERR,			/* map to ROAMING_REASON_TX_ERR(1) */
	ROAMING_REPORT_REASON_RETRY,			/* map to ROAMING_REASON_RETRY(2) */
	ROAMING_REPORT_REASON_IDLE,			/* map to ROAMING_REASON_IDLE(3) */
	ROAMING_REPORT_REASON_UNSPECIFIC,		/* map to ROAMING_REASON_HIGH_CU(4)*/
	ROAMING_REPORT_REASON_UNSPECIFIC,		/* map to ROAMING_REASON_BT_COEX(5) */
	ROAMING_REPORT_REASON_BEACON_TIMEOUT,		/* map to ROAMING_REASON_BEACON_TIMEOUT(6) */
	ROAMING_REPORT_REASON_INACTIVE,			/* map to ROAMING_REASON_INACTIVE(7) */
	ROAMING_REPORT_REASON_SAA_FAIL, 		/* map to ROAMING_REASON_SAA_FAIL(8) */
	ROAMING_REPORT_REASON_UPPER_LAYER_TRIGGER,	/* map to ROAMING_REASON_UPPER_LAYER_TRIGGER(9) */
	ROAMING_REPORT_REASON_BTM,			/* map to ROAMING_REASON_BTM(10) */
	ROAMING_REPORT_REASON_UNSPECIFIC,		/* map to ROAMING_REASON_SCAN_TIMER(11) */
	ROAMING_REPORT_REASON_UNSPECIFIC,		/* map to ROAMING_REASON_INACTIVE_TIMER(12) */
};
