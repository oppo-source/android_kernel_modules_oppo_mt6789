...
enum ENUM_INIT_CMD_ID {
	...
	INIT_CMD_ID_CB_QUERY_PATCH = 0x30,
	INIT_CMD_ID_CB_DOWNLOAD_CONFIG = 0x31,
	INIT_CMD_ID_CB_PATCH_FINISH = 0x32,
...
#if (CFG_MTK_WIFI_SUPPORT_LEGACY_CBMCU_FWDL == 1)
enum ENUM_INIT_CB_PATCH_STATUS {
	CB_PATCH_STATUS_GET_SEMA_NEED_PATCH = 0,   /* get SEMA, need patch */
	CB_PATCH_STATUS_NO_NEED_TO_PATCH,          /* patch is DL & ready */
	CB_PATCH_STATUS_NO_SEMA_NEED_PATCH,        /* no SEMA, need patch */
	CB_PATCH_STATUS_RELEASE_SEMA               /* release SEMA */
};
#endif /* CFG_MTK_WIFI_SUPPORT_LEGACY_CBMCU_FWDL */
...
#if (CFG_MTK_WIFI_SUPPORT_LEGACY_CBMCU_FWDL == 1)
struct INIT_CMD_CB_DOWNLOAD_CONFIG {
	uint32_t u4Address;
	uint32_t u4Length;
};

struct INIT_CMD_CB_PATCH_FINISH {
	uint32_t u4Reserved;
};
#endif /* CFG_MTK_WIFI_SUPPORT_LEGACY_CBMCU_FWDL */
