...
static struct COUNTRY_POWER_LIMIT_COUNTRY_CODE g_u2CountryLimitGrpa[] = {
	{'A','E'},
	{'B','A'}, {'B','D'}, {'B','H'},
	{'D','Z'},
	{'E','T'},
...
static struct COUNTRY_POWER_LIMIT_COUNTRY_CODE g_u2CountryLimitGrpb[] = {
	{'C','L'}, {'C','R'}
};
static struct COUNTRY_POWER_LIMIT_COUNTRY_CODE g_u2CountryLimitGrpc[] = {
	{'S','A'}
};
static struct COUNTRY_POWER_LIMIT_COUNTRY_CODE g_u2CountryLimitGrpd[] = {
	{'C','O'},
	{'D','O'},
	{'P','E'},
	{'S','V'},
...
struct COUNTRY_POWER_LIMIT_GROUP_TABLE arSupportCountryPowerLmtGrps[] = {
	...
	{
		{'G', '4'},
		sizeof(g_u2CountryLimitGrp4) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrp4
	},
	{
		{'G', '5'},
		sizeof(g_u2CountryLimitGrp5) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrp5
	},
	{
		{'G', '6'},
		sizeof(g_u2CountryLimitGrp6) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrp6
	},
	{
		{'G', '7'},
		sizeof(g_u2CountryLimitGrp7) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrp7
	},
	{
		{'G', '8'},
		sizeof(g_u2CountryLimitGrp8) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrp8
	},
	{
		{'G', '9'},
		sizeof(g_u2CountryLimitGrp9) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrp9
	},
	{
		{'G', 'a'},
		sizeof(g_u2CountryLimitGrpa) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrpa
	},
	{
		{'G', 'b'},
		sizeof(g_u2CountryLimitGrpb) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrpb
	},
	{
		{'G', 'c'},
		sizeof(g_u2CountryLimitGrpc) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrpc
	},
	{
		{'G', 'd'},
		sizeof(g_u2CountryLimitGrpd) /
			sizeof(struct COUNTRY_POWER_LIMIT_COUNTRY_CODE),
		g_u2CountryLimitGrpd
	}
