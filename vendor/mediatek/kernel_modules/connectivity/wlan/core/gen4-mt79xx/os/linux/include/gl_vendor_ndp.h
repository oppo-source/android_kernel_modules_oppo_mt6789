...
enum mtk_wlan_vendor_attr_ndp_params {
	...
	MTK_WLAN_VENDOR_ATTR_NDP_SUBCMD = 1,
	/* Unsigned 16-bit value */
	MTK_WLAN_VENDOR_ATTR_NDP_TRANSACTION_ID = 2,
	/* NL attributes for data used NDP SUB cmds */
	/* Unsigned 32-bit value indicating a service info */
	MTK_WLAN_VENDOR_ATTR_NDP_SERVICE_INSTANCE_ID = 3,
	/* Unsigned 32-bit value; channel frequency in MHz */
	MTK_WLAN_VENDOR_ATTR_NDP_CHANNEL = 4,
	/* Interface Discovery MAC address. An array of 6 Unsigned int8 */
	MTK_WLAN_VENDOR_ATTR_NDP_PEER_DISCOVERY_MAC_ADDR = 5,
	/* Interface name on which NDP is being created */
	MTK_WLAN_VENDOR_ATTR_NDP_IFACE_STR = 6,
	/* Unsigned 32-bit value for security */
	MTK_WLAN_VENDOR_ATTR_NDP_CONFIG_SECURITY = 7,
	/* Unsigned 32-bit value for QoS */
	MTK_WLAN_VENDOR_ATTR_NDP_CONFIG_QOS = 8,
	/* Array of u8 */
	MTK_WLAN_VENDOR_ATTR_NDP_APP_INFO = 9,
	/* Unsigned 32-bit value for NDP instance Id */
	MTK_WLAN_VENDOR_ATTR_NDP_INSTANCE_ID = 10,
	/* Array of instance Ids */
	MTK_WLAN_VENDOR_ATTR_NDP_INSTANCE_ID_ARRAY = 11,
	/* Unsigned 32-bit value for initiator/responder NDP response code */
	MTK_WLAN_VENDOR_ATTR_NDP_RESPONSE_CODE = 12,
	/* NDI MAC address. An array of 6 Unsigned int8 */
	MTK_WLAN_VENDOR_ATTR_NDP_NDI_MAC_ADDR = 13,
	...
	/* Unsigned 16-bit value */
	MTK_WLAN_VENDOR_ATTR_NDP_PUB_ID = 30,
	/* Multicast address. An array of 6 Unsigned int8 */
	MTK_WLAN_VENDOR_ATTR_NDP_MULTICAST_ADDR = 31,
