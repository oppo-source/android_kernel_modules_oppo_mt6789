...
#define IW_PRIV_BUF_SIZE			2046
#else /* CFG_SUPPORT_SCAN_RADIOINFO is 0 */
#define IW_PRIV_BUF_SIZE			2000
#endif /* end CFG_SUPPORT_SCAN_RADIOINFO */

/* NAN */
#define WLAN_CAPABILITIES_NAN_6G                   0x0000000000000800ULL
#define WLAN_CAPABILITIES_NAN_PAIRING              0x0000000000004000ULL
#define WLAN_CAPABILITIES_NAN_USD                  0x0000000001000000ULL
#define WLAN_CAPABILITIES_NAN_KEY_MANAGEMENT       0x0000000004000000ULL
#define WLAN_CAPABILITIES_NAN_MC_DATA              0x0000000010000000ULL
#define WLAN_CAPABILITIES_NAN_GROUP_KEY            0x0000000020000000ULL
/*******************************************************************************
 *                             D A T A   T Y P E S
 *******************************************************************************
 */
