...
#define NAN_ATTR_ID_DEVICE_CAPABILITY_EXT 0x2A /* DCEA */
#define NAN_ATTR_ID_NAN_ID_RESOLUTION 0x2B /* NIRA */
#define NAN_ATTR_ID_NAN_PAIRING_BOOTSTRAPPING 0x2C /* NPBA */
...
#define NAN_DEVICE_CAPABILITY_EXT_REG_INFO_EN_6G BIT(0)
...
#define NAN_DEV_CAP_OP_MODE_PHY_MODE_HE (4)
...
#define CSIA_CAP_GTKSA_IGTKSA_SUPPORTED_BIGTKSA_UNSUPPORTED	1
