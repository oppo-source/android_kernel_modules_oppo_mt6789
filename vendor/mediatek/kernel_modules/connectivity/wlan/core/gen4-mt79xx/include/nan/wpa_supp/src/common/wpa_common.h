...
#define WPA_IV_LEN 16
#define WPA_MIC_LEN 16
#define WPA_MIC_192_LEN 24
#define WPA_RESERVED_LEN 8
...
#define WPA_EAPOL_KEY_LEN sizeof(struct wpa_eapol_key)
#define WPA_EAPOL_KEY_192_LEN sizeof(struct wpa_eapol_key_192)

#define WPA_EAPOL_KEY_MIC_LEN 16
...
struct wpa_ptk {
	...
	u8 kdk[WPA_KDK_MAX_LEN]; /* EAPOL-Key Key Derivation Key (KDK) */
