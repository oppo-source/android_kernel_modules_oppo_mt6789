...
enum ENUM_LOC_SUB_CMD {
	CMD_LOC_GET_CAPA = 0,
	CMD_LOC_RANGE_MC_ISTA = 1, /* 11mc iSTA */
	CMD_LOC_RANGE_MC_RSTA = 2, /* 11mc rSTA */

	/* currently Unused, sync with FW*/
	CMD_LOC_RANGE_REQ_AZ_NTB = 3,
	CMD_LOC_REQ_AZ_NTB_PHY_SEC = 4,
	CMD_LOC_RSP_ENABLE = 5,
	CMD_LOC_DEBUG = 6,
	CMD_LOC_REQ_MC_BURST = 7,
	CMD_LOC_TOAE_CAL_CFG = 8,
	CMD_LOC_FTMR_TIMEOUT = 9,
	CMD_LOC_NUM
};
...
/* 11mc ranging request*/
struct LOC_CMD_RANGE_REQUEST_MC_ISTA {
	uint8_t ucSeqNum;
...
struct LOC_CMD_RANGE_REQUEST_MC_RSTA {
	uint8_t ucSeqNum;
	uint8_t fgEnable;              /* request or cancel */
	uint8_t ucConfigNum;
	uint8_t ucPaddings[5];
