...
#define os_memcpyS(pvDst, szDst, pvSrc, szSrc)	\
	kalMemCpyS(pvDst, szDst, pvSrc, szSrc)
...
#define nan_os_memcpyS(pvDst, szDst, pvSrc, szSrc)	\
	kalMemCpyS(pvDst, szDst, pvSrc, szSrc)

void *nan_os_memset(void *s, int c, size_t n);

int nan_os_memcmp(const void *s1, const void *s2, size_t n);
