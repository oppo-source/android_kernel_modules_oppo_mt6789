...
void kbase_csf_scheduler_reset(struct kbase_device *kbdev, bool skip_suspension)
{
	...
	if (mtk_common_whitebox_force_terminate_csg_enable_get()) {
		mtk_common_whitebox_force_terminate_csg_enable_set(0);
