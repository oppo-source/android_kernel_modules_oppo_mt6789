...
int add_external_subdrv_entry_isp8s(struct subdrv_entry *target)
{
...
EXPORT_SYMBOL(add_external_subdrv_entry_isp8s);

struct external_entry *query_external_subdrv_entry_isp8s(const char *name)
{
	struct external_entry *entry = NULL;
...
EXPORT_SYMBOL(query_external_subdrv_entry_isp8s);
