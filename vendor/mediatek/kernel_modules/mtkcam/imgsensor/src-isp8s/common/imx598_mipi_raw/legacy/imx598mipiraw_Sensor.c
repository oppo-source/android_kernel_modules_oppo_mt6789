...
struct subdrv_static_ctx imx598_legacy_s_ctx = {
#else
...
#ifdef IMX598_ISF_DBG
const struct subdrv_entry imx598_mipi_raw_entry_legacy = {
#else
...
{
#ifdef IMX598_ISF_DBG
	memcpy(&(ctx->s_ctx), &imx598_legacy_s_ctx, sizeof(struct subdrv_static_ctx));
#else
