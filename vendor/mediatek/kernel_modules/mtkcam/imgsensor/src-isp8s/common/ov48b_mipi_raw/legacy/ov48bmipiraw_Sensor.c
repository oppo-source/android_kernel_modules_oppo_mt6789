...
#ifdef OV48B_ISF_DBG
struct subdrv_static_ctx ov48b_legacy_s_ctx = {
#else
...
#ifdef OV48B_ISF_DBG
const struct subdrv_entry ov48b_mipi_raw_entry_legacy = {
#else
...
static int ov48b_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	set_table_to_buffer(ctx, addr_data_pair_seamless_switch_step2_ov48b2q,
	...
	set_table_to_buffer(ctx, addr_data_pair_seamless_switch_step3_ov48b2q,
...
{
#ifdef OV48B_ISF_DBG
	memcpy(&(ctx->s_ctx), &ov48b_legacy_s_ctx, sizeof(struct subdrv_static_ctx));
#else
