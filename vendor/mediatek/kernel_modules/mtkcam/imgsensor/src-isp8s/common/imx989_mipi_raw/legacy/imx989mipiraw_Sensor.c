...
static struct mtk_mbus_frame_desc_entry frame_desc_cus46[] = {
	{
		.bus.csi2 = {
			.channel = 0,
			.data_type = 0x2b,
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	{
		.frame_desc = frame_desc_cus46,
		.num_entries = ARRAY_SIZE(frame_desc_cus46),
		.mode_setting_table = imx989_custom46_setting,
		.mode_setting_len = ARRAY_SIZE(imx989_custom46_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
struct subdrv_static_ctx imx989_legacy_s_ctx = {
#else
...
#ifdef IMX989_ISF_DBG
const struct subdrv_entry imx989_mipi_raw_entry_legacy = {
#else
...
{
#ifdef IMX989_ISF_DBG
	memcpy(&(ctx->s_ctx), &imx989_legacy_s_ctx, sizeof(struct subdrv_static_ctx));
#else
