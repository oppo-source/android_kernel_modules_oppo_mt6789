...
u16 addr_data_pair_init_ov50d2q[] = {
	0x0102, 0x01,
	0x0103, 0x01,
	0x0301, 0xc8,
	0x0304, 0x01,
	0x0305, 0x24, //MCLK=26Mhz
	0x0306, 0x04, //4 lane
	0x0307, 0x00,
	0x0326, 0xcb,
	0x0360, 0x01,
...
u16 addr_data_pair_preview_ov50d2q[] = {
	...
	0x3769,	0x50,
	0x376c,	0x00,
	0x3800,	0x00, //x_addr_start[15:8]
	0x3801,	0x00, //x_addr_start[7:0]
	0x3802,	0x00,
	0x3803,	0x00,
	0x3804,	0x20, //x_addr_end[15:8]
	0x3805,	0x3f, //x_addr_end[7:0]
	0x3806,	0x18,
	0x3807,	0x3f,
	0x3808,	0x0f, //x_output[15:8]
	0x3809,	0xa0, //x_output[7:0]
	0x380a,	0x0b,
	0x380b,	0xb8,
	0x380c,	0x01, //HTS
	0x380d,	0xa9, //HTS
	...
	0x3811,	0x41, //x offset
	0x3812,	0x00, //y offset
	0x3813,	0x34, //y offset
	0x3814,	0x11,
	0x3815,	0x11,
	0x381a,	0x0f,
	0x381b,	0x48,
...
u16 addr_data_pair_capture_ov50d2q[] = {
	0x0305,	0x24, //MCLK=26Mhz
	0x0325,	0x2a, //MCLK=26Mhz
	0x0326,	0xcb,
	0x0360,	0x01,
...
u16 addr_data_pair_video_ov50d2q[] = {
	0x0305,	0x24, //MCLK=26Mhz
	0x0325,	0x2a, //MCLK=26Mhz
	0x0326,	0xcb,
	0x0360,	0x01,
...
u16 addr_data_pair_hs_video_ov50d2q[] = {
	0x0305, 0x24, //MCLK=26Mhz
	0x0325, 0x2a, //MCLK=26Mhz
	0x0326, 0xcb,
	0x0360, 0x01,
...
u16 addr_data_pair_slim_video_ov50d2q[] = {
	0x0305, 0x24, //MCLK=26Mhz
	0x0325, 0x2a, //MCLK=26Mhz
	0x0326, 0xcb,
	0x0360, 0x01,
...
u16 addr_data_pair_custom1_ov50d2q[] = {
	0x0305, 0x24, //MCLK=26Mhz
	0x0325, 0x2a, //MCLK=26Mhz
	0x0326, 0xcb,
	0x0360, 0x01,
...
u16 addr_data_pair_custom2_ov50d2q[] = {
	0x0305, 0x24, //MCLK=26Mhz
	0x0325, 0x2a, //MCLK=26Mhz
	0x0326, 0xcb,
	0x0360, 0x01,
...
u16 addr_data_pair_custom3_ov50d2q[] = {
	0x0305, 0x24, //MCLK=26Mhz
	0x0325, 0x2a, //MCLK=26Mhz
	0x0326, 0xcb,
	0x0360, 0x01,
...
u16 addr_data_pair_custom4_ov50d2q[] = {
	0x0305, 0x3b, //MCLK=26Mhz
	0x0325, 0x2a, //MCLK=26Mhz
	0x0326, 0x8b,
	0x0360, 0x00,
	0x300f, 0x88,
...
u16 addr_data_pair_custom5_ov50d2q[] = {
	0x0305, 0x3b,//MCLK=26Mhz
	0x0325, 0x2a,//MCLK=26Mhz
	0x0326, 0x8b,
	0x0360, 0x00,
...
u16 addr_data_pair_custom6_ov50d2q[] = {
	0x0305, 0x3b,//MCLK=26Mhz
	0x0325, 0x2a,//MCLK=26Mhz
	0x0326, 0x8b,
	0x0360, 0x00,
