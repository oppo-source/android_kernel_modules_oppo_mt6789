...
#ifdef IMX758_ISF_DBG
struct subdrv_static_ctx imx758_legacy_s_ctx = {
#else
...
#ifdef IMX758_ISF_DBG
const struct subdrv_entry imx758_mipi_raw_entry_legacy = {
#else
...
{
#ifdef IMX758_ISF_DBG
	memcpy(&(ctx->s_ctx), &imx758_legacy_s_ctx, sizeof(struct subdrv_static_ctx));
#else
