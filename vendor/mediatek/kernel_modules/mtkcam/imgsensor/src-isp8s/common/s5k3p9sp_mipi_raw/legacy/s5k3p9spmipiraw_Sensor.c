...
struct subdrv_static_ctx s5k3p9_legacy_s_ctx = {
#else
...
#ifdef S5K3P9_ISF_DBG
const struct subdrv_entry s5k3p9_mipi_raw_entry_legacy = {
#else
...
{
#ifdef S5K3P9_ISF_DBG
	memcpy(&(ctx->s_ctx), &s5k3p9_legacy_s_ctx, sizeof(struct subdrv_static_ctx));
#else
