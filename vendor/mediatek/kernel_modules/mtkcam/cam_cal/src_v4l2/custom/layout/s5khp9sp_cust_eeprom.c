...
static unsigned int do_2a_gain_s5khp9sp(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_s5khp9sp(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x0000000A, 0x07163702, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000001, 0x00000002, do_part_number},
		{0x00000001, 0x0000009D, 0x0000074C, do_single_lsc_s5khp9sp},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_s5khp9sp},
		{0x00000001, 0x00002C8E, 0x000016E0, do_pdaf},
		{0x00000000, 0x00000000, 0x00000000, do_stereo_data},
		{0x00000001, 0x00000000, 0x00008000, do_dump_all},
		{0x00000001, 0x00000000, 0x00000000, do_lens_id_s5khp9sp}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT s5khp9sp_cust_eeprom = {
	.name = "s5khp9sp_cust_eeprom",
