	...
	struct device *dev)
{
	...
	case CAMSV_0:
		/* wdma 1 */
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON3_IMG_1, 0x86660555);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON2_IMG_1, 0x14440333);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON1_IMG_1, 0x12220111);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON4_IMG_1, 0x81110000);
		/* wdma 2 */
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON3_IMG_2, 0x84000355);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON2_IMG_2, 0x12AB0200);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON1_IMG_2, 0x115600AB);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON4_IMG_2, 0x80AB0000);
		break;
	case CAMSV_1:
		/* wdma 1 */
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON3_IMG_1, 0x86660555);
	...
	case CAMSV_2:
		/* wdma1 */
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON3_IMG_1, 0x84CE0401);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON2_IMG_1, 0x13340267);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON1_IMG_1, 0x119A00CD);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON4_IMG_1, 0x80CD0000);
		break;
	case CAMSV_3:
		/* imgo */
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON3_IMG_1, 0x83000280);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON2_IMG_1, 0x12000180);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON1_IMG_1, 0x11000080);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON4_IMG_1, 0x80800000);
		break;
	case CAMSV_4:
		/* imgo */
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON3_IMG_1, 0x80D800B4);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON2_IMG_1, 0x1090006C);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON1_IMG_1, 0x10480024);
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON4_IMG_1, 0x80240000);
		break;
	case CAMSV_5:
		/* imgo */
		CAMSV_WRITE_REG(camsv_dev->base_dma + REG_CAMSVDMATOP_CON3_IMG_1, 0x80D800B4);
