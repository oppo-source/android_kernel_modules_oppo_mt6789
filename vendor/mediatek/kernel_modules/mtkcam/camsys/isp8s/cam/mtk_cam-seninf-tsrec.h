...
/*
 * !!! this API is "ONLY available when SENINF/TSREC/Sensor is in streaming" !!!
 * => for user to enable/disable TSREC "extra" exp vsync interrupt.
 * P.S., tsrec driver has its own interrupt ctrl requirements.
 *
 * e.g., user wants to ctrl 2nd-exp vsync interrupt.
 * => enable  --> (exp0_en:0 / exp1_en:1 / exp2_en:0)
 * => disable --> (exp0_en:0 / exp1_en:0 / exp2_en:0)
 *
 * retrun:
 *      0     => NO ERROR, apply user request.
 *      other => ERROR happened, will NOT apply the request from user.
 */
