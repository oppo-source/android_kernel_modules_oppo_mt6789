...
#define qof_mtcmos_voter(eng, used_raw, enable) \
	__qof_mtcmos_voter(eng, used_raw, enable, __func__, __LINE__)

int __qof_mtcmos_raw_voter(struct mtk_raw_device *raw, bool enable,
	const char *caller, int line);
#define qof_mtcmos_raw_voter(raw, enable) \
	__qof_mtcmos_raw_voter(raw, enable, __func__, __LINE__)
...
#define qof_mtcmos_voter_handle(eng, used_raw, handle) \
	__qof_mtcmos_voter_handle(eng, used_raw, handle, __func__, __LINE__)
