...
#define DC_DBG_LN_STORE		3
struct mtk_raw_dc_dbg_ln {
	u64 cur_boottime_ns;
	u64 irq_boottime_ns;
	u32 rawi5;
	u32 ufdi5;
...
struct mtk_raw_device {
	...
	u32 target_dcif_cq_start;

	u32 dc_dbg_ln_idx;
	struct mtk_raw_dc_dbg_ln dc_dbg_ln[DC_DBG_LN_STORE];
};
...
void mtk_raw_push_dc_dbg_ln(struct mtk_raw_device *dev, u64 irq_boottime_ns);
