...
#define FOURCC_M(pfmt, shift)		((char)(((pfmt) >> shift) & 0x7f)),
#define FOURCC_E(pfmt, shift)	((char)(((pfmt) >> shift) & 0x7f))
#define MEMBER_FOURCC(pfmt) \
	FOURCC_S(pfmt)FOURCC_M(pfmt, 0)FOURCC_M(pfmt, 8)FOURCC_M(pfmt, 16)FOURCC_E(pfmt, 24)
