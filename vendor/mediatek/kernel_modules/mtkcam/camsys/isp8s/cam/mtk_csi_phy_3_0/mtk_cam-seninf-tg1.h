...
#define SENINF_TG_SENINF_TG_TM_CORE0_FMT_SHIFT 28
#define SENINF_TG_SENINF_TG_TM_CORE0_FMT_MASK (0x7 << 28)
...
#define SENINF_TG_SENINF_TG_TM_CORE1_FMT_SHIFT 28
#define SENINF_TG_SENINF_TG_TM_CORE1_FMT_MASK (0x7 << 28)
...
#define SENINF_TG_SENINF_TG_TM_EXP1_WD_RATIO_MASK (0x3 << 0)
#define SENINF_TG_SENINF_TG_TM_EXP1_HT_RATIO_SHIFT 4
#define SENINF_TG_SENINF_TG_TM_EXP1_HT_RATIO_MASK (0x7 << 4)
#define SENINF_TG_SENINF_TG_TM_EXP1_DELAY_SHIFT 12
#define SENINF_TG_SENINF_TG_TM_EXP1_DELAY_MASK (0xffff << 12)
...
#define SENINF_TG_SENINF_TG_TM_EXP2_WD_RATIO_MASK (0x3 << 0)
#define SENINF_TG_SENINF_TG_TM_EXP2_HT_RATIO_SHIFT 4
#define SENINF_TG_SENINF_TG_TM_EXP2_HT_RATIO_MASK (0x7 << 4)
#define SENINF_TG_SENINF_TG_TM_EXP2_DELAY_SHIFT 12
#define SENINF_TG_SENINF_TG_TM_EXP2_DELAY_MASK (0xffff << 12)
...
#define SENINF_TG_SENINF_TG_TM_EXP3_WD_RATIO_MASK (0x3 << 0)
#define SENINF_TG_SENINF_TG_TM_EXP3_HT_RATIO_SHIFT 4
#define SENINF_TG_SENINF_TG_TM_EXP3_HT_RATIO_MASK (0x7 << 4)
#define SENINF_TG_SENINF_TG_TM_EXP3_DELAY_SHIFT 12
#define SENINF_TG_SENINF_TG_TM_EXP3_DELAY_MASK (0xffff << 12)
...
#define SENINF_TG_SENINF_TG_TM_EXP4_WD_RATIO_MASK (0x3 << 0)
#define SENINF_TG_SENINF_TG_TM_EXP4_HT_RATIO_SHIFT 4
#define SENINF_TG_SENINF_TG_TM_EXP4_HT_RATIO_MASK (0x7 << 4)
#define SENINF_TG_SENINF_TG_TM_EXP4_DELAY_SHIFT 12
#define SENINF_TG_SENINF_TG_TM_EXP4_DELAY_MASK (0xffff << 12)
...
#define SENINF_TG_SENINF_TG_TM_EXP5_WD_RATIO_MASK (0x3 << 0)
#define SENINF_TG_SENINF_TG_TM_EXP5_HT_RATIO_SHIFT 4
#define SENINF_TG_SENINF_TG_TM_EXP5_HT_RATIO_MASK (0x7 << 4)
#define SENINF_TG_SENINF_TG_TM_EXP5_DELAY_SHIFT 12
#define SENINF_TG_SENINF_TG_TM_EXP5_DELAY_MASK (0xffff << 12)
...
#define SENINF_TG_SENINF_TG_TM_EXP6_WD_RATIO_MASK (0x3 << 0)
#define SENINF_TG_SENINF_TG_TM_EXP6_HT_RATIO_SHIFT 4
#define SENINF_TG_SENINF_TG_TM_EXP6_HT_RATIO_MASK (0x7 << 4)
#define SENINF_TG_SENINF_TG_TM_EXP6_DELAY_SHIFT 12
#define SENINF_TG_SENINF_TG_TM_EXP6_DELAY_MASK (0xffff << 12)
...
#define SENINF_TG_SENINF_TG_TM_EXP7_WD_RATIO_MASK (0x3 << 0)
#define SENINF_TG_SENINF_TG_TM_EXP7_HT_RATIO_SHIFT 4
#define SENINF_TG_SENINF_TG_TM_EXP7_HT_RATIO_MASK (0x7 << 4)
#define SENINF_TG_SENINF_TG_TM_EXP7_DELAY_SHIFT 12
#define SENINF_TG_SENINF_TG_TM_EXP7_DELAY_MASK (0xffff << 12)
#define SENINF_TG_SENINF_TG_TM_EXP7_VC_MODE_SHIFT 30
#define SENINF_TG_SENINF_TG_TM_EXP7_VC_MODE_MASK (0x3 << 30)

#define SENINF_TG_SENINF_TG_TM_MODE_SWITCH  0x0060
#define SENINF_TG_SENINF_TG_TM_IDLE_LINE_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_IDLE_LINE_MASK (0xffff << 0)
#define SENINF_TG_SENINF_TG_TM_DB_LOAD_EN_CORE1_SHIFT 28
#define SENINF_TG_SENINF_TG_TM_DB_LOAD_EN_CORE1_MASK (0x1 << 28)
#define SENINF_TG_SENINF_TG_TM_MODE_SWITCH_TRIG_CORE1_SHIFT 29
#define SENINF_TG_SENINF_TG_TM_MODE_SWITCH_TRIG_CORE1_MASK (0x1 << 29)
#define SENINF_TG_SENINF_TG_TM_DB_LOAD_EN_CORE0_SHIFT 30
#define SENINF_TG_SENINF_TG_TM_DB_LOAD_EN_CORE0_MASK (0x1 << 30)
#define SENINF_TG_SENINF_TG_TM_MODE_SWITCH_TRIG_CORE0_SHIFT 31
#define SENINF_TG_SENINF_TG_TM_MODE_SWITCH_TRIG_CORE0_MASK (0x1 << 31)

#define SENINF_TG_SENINF_TG_TM_EXP1_SLICE_CTL  0x0064
#define SENINF_TG_SENINF_TG_TM_EXP1_SLICE_SIZE_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_EXP1_SLICE_SIZE_MASK (0xf << 0)
#define SENINF_TG_SENINF_TG_TM_EXP1_SLICE_INTERVAL_SHIFT 16
#define SENINF_TG_SENINF_TG_TM_EXP1_SLICE_INTERVAL_MASK (0x3fff << 16)
#define SENINF_TG_SENINF_TG_TM_EXP1_DATA_MODE_SHIFT 30
#define SENINF_TG_SENINF_TG_TM_EXP1_DATA_MODE_MASK (0x3 << 30)

#define SENINF_TG_SENINF_TG_TM_EXP2_SLICE_CTL  0x0068
#define SENINF_TG_SENINF_TG_TM_EXP2_SLICE_SIZE_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_EXP2_SLICE_SIZE_MASK (0xf << 0)
#define SENINF_TG_SENINF_TG_TM_EXP2_SLICE_INTERVAL_SHIFT 16
#define SENINF_TG_SENINF_TG_TM_EXP2_SLICE_INTERVAL_MASK (0x3fff << 16)
#define SENINF_TG_SENINF_TG_TM_EXP2_DATA_MODE_SHIFT 30
#define SENINF_TG_SENINF_TG_TM_EXP2_DATA_MODE_MASK (0x3 << 30)

#define SENINF_TG_SENINF_TG_TM_EXP3_SLICE_CTL  0x006c
#define SENINF_TG_SENINF_TG_TM_EXP3_SLICE_SIZE_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_EXP3_SLICE_SIZE_MASK (0xf << 0)
#define SENINF_TG_SENINF_TG_TM_EXP3_SLICE_INTERVAL_SHIFT 16
#define SENINF_TG_SENINF_TG_TM_EXP3_SLICE_INTERVAL_MASK (0x3fff << 16)
#define SENINF_TG_SENINF_TG_TM_EXP3_DATA_MODE_SHIFT 30
#define SENINF_TG_SENINF_TG_TM_EXP3_DATA_MODE_MASK (0x3 << 30)

#define SENINF_TG_SENINF_TG_TM_EXP4_SLICE_CTL  0x0070
#define SENINF_TG_SENINF_TG_TM_EXP4_SLICE_SIZE_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_EXP4_SLICE_SIZE_MASK (0xf << 0)
#define SENINF_TG_SENINF_TG_TM_EXP4_SLICE_INTERVAL_SHIFT 16
#define SENINF_TG_SENINF_TG_TM_EXP4_SLICE_INTERVAL_MASK (0x3fff << 16)
#define SENINF_TG_SENINF_TG_TM_EXP4_DATA_MODE_SHIFT 30
#define SENINF_TG_SENINF_TG_TM_EXP4_DATA_MODE_MASK (0x3 << 30)

#define SENINF_TG_SENINF_TG_TM_EXP5_SLICE_CTL  0x0074
#define SENINF_TG_SENINF_TG_TM_EXP5_SLICE_SIZE_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_EXP5_SLICE_SIZE_MASK (0xf << 0)
#define SENINF_TG_SENINF_TG_TM_EXP5_SLICE_INTERVAL_SHIFT 16
#define SENINF_TG_SENINF_TG_TM_EXP5_SLICE_INTERVAL_MASK (0x3fff << 16)
#define SENINF_TG_SENINF_TG_TM_EXP5_DATA_MODE_SHIFT 30
#define SENINF_TG_SENINF_TG_TM_EXP5_DATA_MODE_MASK (0x3 << 30)

#define SENINF_TG_SENINF_TG_TM_EXP6_SLICE_CTL  0x0078
#define SENINF_TG_SENINF_TG_TM_EXP6_SLICE_SIZE_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_EXP6_SLICE_SIZE_MASK (0xf << 0)
#define SENINF_TG_SENINF_TG_TM_EXP6_SLICE_INTERVAL_SHIFT 16
#define SENINF_TG_SENINF_TG_TM_EXP6_SLICE_INTERVAL_MASK (0x3fff << 16)
#define SENINF_TG_SENINF_TG_TM_EXP6_DATA_MODE_SHIFT 30
#define SENINF_TG_SENINF_TG_TM_EXP6_DATA_MODE_MASK (0x3 << 30)

#define SENINF_TG_SENINF_TG_TM_EXP7_SLICE_CTL  0x007c
#define SENINF_TG_SENINF_TG_TM_EXP7_SLICE_SIZE_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_EXP7_SLICE_SIZE_MASK (0xf << 0)
#define SENINF_TG_SENINF_TG_TM_EXP7_SLICE_INTERVAL_SHIFT 16
#define SENINF_TG_SENINF_TG_TM_EXP7_SLICE_INTERVAL_MASK (0x3fff << 16)
#define SENINF_TG_SENINF_TG_TM_EXP7_DATA_MODE_SHIFT 30
#define SENINF_TG_SENINF_TG_TM_EXP7_DATA_MODE_MASK (0x3 << 30)

#define SENINF_TG_SENINF_TG_TM_BIT  0x0080
#define SENINF_TG_SENINF_TG_TM_BIT_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_BIT_MASK (0x1fffff << 0)

#define SENINF_TG_SENINF_TG_DYNAMIC_CTL  0x0084
#define SENINF_TG_SENINF_TG_TM_CLRBAR_PXL_SHIFT_SHIFT 0
#define SENINF_TG_SENINF_TG_TM_CLRBAR_PXL_SHIFT_MASK (0x3ff << 0)
#define SENINF_TG_SENINF_TG_TM_LED_PXL_SIZE_SHIFT 12
#define SENINF_TG_SENINF_TG_TM_LED_PXL_SIZE_MASK (0x3ff << 12)
#define SENINF_TG_DYNAMIC_FRAME_SHIFT_SHIFT 24
#define SENINF_TG_DYNAMIC_FRAME_SHIFT_MASK (0x3f << 24)
#define SENINF_TG_LED_EN_SHIFT 31
#define SENINF_TG_LED_EN_MASK (0x1 << 31)

#define SENINF_TG_SENINF_TG_CLR_VALUE  0x0088
#define SENINF_TG_SENINF_TG_CLR_VALUE_SHIFT 0
#define SENINF_TG_SENINF_TG_CLR_VALUE_MASK (0xffffff << 0)
