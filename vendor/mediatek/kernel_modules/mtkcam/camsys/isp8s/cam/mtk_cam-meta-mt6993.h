...
#define MTK_CAM_UAPI_DFLK_BLK_SIZE (16)
#define MTK_CAM_UAPI_DFLK_MAX_STAT_BLK_NUM (6)
#define MTK_CAM_UAPI_DLFK_MAX_FRAME_HEIGHT (16382)
#define MTK_CAM_UAPI_DLFK_SAMPLE_RATE (2)

#define MTK_CAM_UAPI_DFLKO_MAX_BUF_SIZE \
(MTK_CAM_UAPI_DFLK_BLK_SIZE * MTK_CAM_UAPI_DFLK_MAX_STAT_BLK_NUM * \
MTK_CAM_UAPI_DLFK_MAX_FRAME_HEIGHT / MTK_CAM_UAPI_DLFK_SAMPLE_RATE)

#define MTK_CAM_UAPI_DFLKBO_MAX_BUF_SIZE \
(MTK_CAM_UAPI_DFLK_BLK_SIZE * MTK_CAM_UAPI_DFLK_MAX_STAT_BLK_NUM * \
MTK_CAM_UAPI_DLFK_MAX_FRAME_HEIGHT / MTK_CAM_UAPI_DLFK_SAMPLE_RATE)

#define MTK_CAM_DFLK_BLK_NUM (3)
#define MTK_CAM_DFLK_BLK_SIZE (10)

struct mtk_cam_uapi_dflk_stats {
  __u8 dual_sel;
  __u8 blk_num[MTK_CAM_DFLK_BLK_NUM];
  __u32 blk_size[MTK_CAM_DFLK_BLK_SIZE];
  struct mtk_cam_uapi_meta_hw_buf dflko_buf;
  struct mtk_cam_uapi_meta_hw_buf dflkbo_buf;
};
...
#define MTK_CAM_UAPI_TSFSO_SIZE (96 * 72 * 3 * 4 * 2)
...
struct mtk_cam_uapi_tsf_stats {
  ...
  struct mtk_cam_uapi_meta_hw_buf tsfo_r3_buf;
  struct mtk_cam_uapi_meta_hw_buf tsfo_r4_buf;
};
...
/*
 * struct dflk_param - DFLK parameters *
 */
struct mtk_cam_uapi_dflk_param {
  __u32 sample_rate;
};
...
struct mtk_cam_uapi_meta_raw_stats_0 {
	...
	struct mtk_cam_uapi_dflk_stats dflk_stats;
