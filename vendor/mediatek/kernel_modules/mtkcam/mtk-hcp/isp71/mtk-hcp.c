...
int mtk_hcp_register_isp71(struct platform_device *pdev,
...
EXPORT_SYMBOL(mtk_hcp_register_isp71);
...
EXPORT_SYMBOL(mtk_hcp_unregister_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_current_task_isp71);
...
EXPORT_SYMBOL(mtk_hcp_send_isp71);
...
EXPORT_SYMBOL(mtk_hcp_send_async_isp71);
...
EXPORT_SYMBOL_GPL(mtk_hcp_set_apu_dc_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_plat_device_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_gce_mem_virt_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_wpe_mem_virt_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_wpe_mem_cq_fd_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_wpe_mem_tdr_fd_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_dip_mem_virt_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_dip_mem_cq_fd_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_dip_mem_tdr_fd_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_gce_buffer_isp71);
...
EXPORT_SYMBOL(mtk_hcp_put_gce_buffer_isp71);
...
EXPORT_SYMBOL(mtk_hcp_get_hwid_mem_virt_isp71);
...
#if SMVR_DECOUPLE
int mtk_hcp_allocate_working_buffer_isp71(struct platform_device *pdev, unsigned int mode, unsigned int g_gmb_en)
#else
...
EXPORT_SYMBOL(mtk_hcp_allocate_working_buffer_isp71);
...
EXPORT_SYMBOL(mtk_hcp_release_gce_working_buffer_isp71);
#endif
...
EXPORT_SYMBOL(mtk_hcp_release_working_buffer_isp71);
...
int mtk_hcp_get_init_info_isp71(struct platform_device *pdev,
...
EXPORT_SYMBOL(mtk_hcp_get_init_info_isp71);
...
EXPORT_SYMBOL(mtk_hcp_purge_msg_isp71);
...
static const struct of_device_id mtk_hcp_match[] = {
	{.compatible = "mediatek,hcp71", .data = (void *)&isp71_hcp_data},
	{}
};
