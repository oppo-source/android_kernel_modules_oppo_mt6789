 ...
 */
int mtk_hcp_register_isp71(struct platform_device *pdev, enum hcp_id id,
 ...
 */
int mtk_hcp_unregister_isp71(struct platform_device *pdev, enum hcp_id id);
 ...
 **/
int mtk_hcp_send_isp71(struct platform_device *pdev,
 ...
 * Return: Return 0 if sending data successfully, otherwise it is failed.
 **/
int mtk_hcp_send_async_isp71(struct platform_device *pdev,
		 enum hcp_id id, void *buf,
 ...
 */
int mtk_hcp_set_apu_dc_isp71(struct platform_device *pdev,
 ...
 **/
struct platform_device *mtk_hcp_get_plat_device_isp71(struct platform_device *pdev);
 ...
 **/
struct task_struct *mtk_hcp_get_current_task_isp71(struct platform_device *pdev);
 ...
 **/
#if !SMVR_DECOUPLE
int mtk_hcp_allocate_working_buffer_isp71(struct platform_device *pdev, unsigned int mode);
#else
int mtk_hcp_allocate_working_buffer_isp71(struct platform_device *pdev, unsigned int mode, unsigned int gmb_en);
#endif
 ...
 **/
int mtk_hcp_release_gce_working_buffer_isp71(struct platform_device *pdev);

#if !SMVR_DECOUPLE
void *mtk_hcp_get_gce_mem_virt_isp71(struct platform_device *pdev);
void *mtk_hcp_get_wpe_mem_virt_isp71(struct platform_device *pdev);
int mtk_hcp_get_wpe_mem_cq_fd_isp71(struct platform_device *pdev);
int mtk_hcp_get_wpe_mem_tdr_fd_isp71(struct platform_device *pdev);
void *mtk_hcp_get_dip_mem_virt_isp71(struct platform_device *pdev);
int mtk_hcp_get_dip_mem_cq_fd_isp71(struct platform_device *pdev);
int mtk_hcp_get_dip_mem_tdr_fd_isp71(struct platform_device *pdev);
void *mtk_hcp_get_traw_mem_virt_isp71(struct platform_device *pdev);
int mtk_hcp_get_traw_mem_cq_fd_isp71(struct platform_device *pdev);
int mtk_hcp_get_traw_mem_tdr_fd_isp71(struct platform_device *pdev);
void *mtk_hcp_get_pqdip_mem_virt_isp71(struct platform_device *pdev);
int mtk_hcp_get_pqdip_mem_cq_fd_isp71(struct platform_device *pdev);
int mtk_hcp_get_pqdip_mem_tdr_fd_isp71(struct platform_device *pdev);
void *mtk_hcp_get_hwid_mem_virt_isp71(struct platform_device *pdev);
int mtk_hcp_get_gce_buffer_isp71(struct platform_device *pdev);
int mtk_hcp_put_gce_buffer_isp71(struct platform_device *pdev);

#else
int mtk_hcp_ioc_release_working_buffer_isp71(struct platform_device *pdev, unsigned int mode);
void *mtk_hcp_get_gce_mem_virt_isp71(struct platform_device *pdev, unsigned int mode);
void *mtk_hcp_get_gce_token_mem_virt_isp71(struct platform_device *pdev, unsigned int mode);
void *mtk_hcp_get_wpe_mem_virt_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_get_wpe_mem_cq_fd_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_get_wpe_mem_tdr_fd_isp71(struct platform_device *pdev, unsigned int mode);
void *mtk_hcp_get_dip_mem_virt_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_get_dip_mem_cq_fd_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_get_dip_mem_tdr_fd_isp71(struct platform_device *pdev, unsigned int mode);
void *mtk_hcp_get_traw_mem_virt_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_get_traw_mem_cq_fd_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_get_traw_mem_tdr_fd_isp71(struct platform_device *pdev, unsigned int mode);
void *mtk_hcp_get_pqdip_mem_virt_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_get_pqdip_mem_cq_fd_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_get_pqdip_mem_tdr_fd_isp71(struct platform_device *pdev, unsigned int mode);
void *mtk_hcp_get_hwid_mem_virt_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_get_mem_info_isp71(struct platform_device *pdev, struct img_init_info *info, unsigned int mode);
int mtk_hcp_get_gce_buffer_isp71(struct platform_device *pdev, unsigned int mode);
int mtk_hcp_put_gce_buffer_isp71(struct platform_device *pdev, unsigned int mode);

#endif
int mtk_hcp_release_working_buffer_isp71(struct platform_device *pdev);

int mtk_hcp_get_init_info_isp71(struct platform_device *pdev, struct img_init_info *info);
 ...
 **/
void mtk_hcp_purge_msg_isp71(struct platform_device *pdev);
