...
#define PDA_KERNEL_VERSION 5000
...
#define PDA_PDAI_P1_BASE_ADDR_REG (0x1cc)
#define PDA_PDATI_P1_BASE_ADDR_REG (0x1d0)
#define PDA_PDAI_P2_BASE_ADDR_REG (0x1d4)
#define PDA_PDATI_P2_BASE_ADDR_REG (0x1d8)
#define PDA_PDAI_STRIDE_REG (0x1dc)
#define PDA_PDAI_P1_CON0_REG (0x1e0)
#define PDA_PDAI_P1_CON1_REG (0x1e4)
#define PDA_PDAI_P1_CON2_REG (0x1e8)
#define PDA_PDAI_P1_CON3_REG (0x1ec)
#define PDA_PDAI_P1_CON4_REG (0x1f0)
#define PDA_PDATI_P1_CON0_REG (0x1f4)
#define PDA_PDATI_P1_CON1_REG (0x1f8)
#define PDA_PDATI_P1_CON2_REG (0x1fc)
#define PDA_PDATI_P1_CON3_REG (0x200)
#define PDA_PDATI_P1_CON4_REG (0x204)
#define PDA_PDAI_P2_CON0_REG (0x208)
#define PDA_PDAI_P2_CON1_REG (0x20c)
#define PDA_PDAI_P2_CON2_REG (0x210)
#define PDA_PDAI_P2_CON3_REG (0x214)
#define PDA_PDAI_P2_CON4_REG (0x218)
#define PDA_PDATI_P2_CON0_REG (0x21c)
#define PDA_PDATI_P2_CON1_REG (0x220)
#define PDA_PDATI_P2_CON2_REG (0x224)
#define PDA_PDATI_P2_CON3_REG (0x228)
#define PDA_PDATI_P2_CON4_REG (0x22c)
#define PDA_PDAO_P1_BASE_ADDR_REG (0x230)
#define PDA_PDAO_P1_XSIZE_REG (0x234)
#define PDA_PDAO_P1_CON0_REG (0x238)
#define PDA_PDAO_P1_CON1_REG (0x23c)
#define PDA_PDAO_P1_CON2_REG (0x240)
#define PDA_PDAO_P1_CON3_REG (0x244)
#define PDA_PDAO_P1_CON4_REG (0x248)
#define PDA_PDA_DMA_EN_REG (0x24c)
#define PDA_PDA_DMA_RST_REG (0x250)
#define PDA_PDA_DMA_TOP_REG (0x254)
#define PDA_PDA_SECURE_REG (0x258)
#define PDA_PDA_TILE_STATUS_REG (0x25c)
#define PDA_PDA_DCM_DIS_REG (0x260)
#define PDA_PDA_DCM_ST_REG (0x264)
#define PDA_PDAI_P1_ERR_STAT_REG (0x268)
#define PDA_PDATI_P1_ERR_STAT_REG (0x26c)
#define PDA_PDAI_P2_ERR_STAT_REG (0x270)
#define PDA_PDATI_P2_ERR_STAT_REG (0x274)
#define PDA_PDAO_P1_ERR_STAT_REG (0x278)
#define PDA_PDA_ERR_STAT_EN_REG (0x27c)
#define PDA_PDA_ERR_STAT_REG (0x280)
#define PDA_PDA_TOP_CTL_REG (0x284)
#define PDA_PDA_DEBUG_SEL_REG (0x288)
#define PDA_PDA_IRQ_TRIG_REG (0x28c)
#define PDA_PDAI_P1_BASE_ADDR_MSB_REG (0x290)
#define PDA_PDATI_P1_BASE_ADDR_MSB_REG (0x294)
#define PDA_PDAI_P2_BASE_ADDR_MSB_REG (0x298)
#define PDA_PDATI_P2_BASE_ADDR_MSB_REG (0x29c)
#define PDA_PDAO_P1_BASE_ADDR_MSB_REG (0x2a0)
#define PDA_PDAO_DMA_EXISTED_ECO_REG (0x2a4)
#define PDA_PDA_DEBUG_DATA_REG (0x2a8)
#define PDA_PDALI_P3_BASE_ADDR_REG (0x2ac)
#define PDA_PDARI_P3_BASE_ADDR_REG (0x2b0)
#define PDA_PDALI_P4_BASE_ADDR_REG (0x2b4)
#define PDA_PDARI_P4_BASE_ADDR_REG (0x2b8)
#define PDA_PDALI_P5_BASE_ADDR_REG (0x2bc)
#define PDA_PDARI_P5_BASE_ADDR_REG (0x2c0)
#define PDA_PDALI_P3_CON0_REG (0x2c4)
#define PDA_PDALI_P3_CON1_REG (0x2c8)
#define PDA_PDALI_P3_CON2_REG (0x2cc)
#define PDA_PDALI_P3_CON3_REG (0x2d0)
#define PDA_PDALI_P3_CON4_REG (0x2d4)
#define PDA_PDARI_P3_CON0_REG (0x2d8)
#define PDA_PDARI_P3_CON1_REG (0x2dc)
#define PDA_PDARI_P3_CON2_REG (0x2e0)
#define PDA_PDARI_P3_CON3_REG (0x2e4)
#define PDA_PDARI_P3_CON4_REG (0x2e8)
#define PDA_PDALI_P4_CON0_REG (0x2ec)
#define PDA_PDALI_P4_CON1_REG (0x2f0)
#define PDA_PDALI_P4_CON2_REG (0x2f4)
#define PDA_PDALI_P4_CON3_REG (0x2f8)
#define PDA_PDALI_P4_CON4_REG (0x2fc)
#define PDA_PDARI_P4_CON0_REG (0x300)
#define PDA_PDARI_P4_CON1_REG (0x304)
#define PDA_PDARI_P4_CON2_REG (0x308)
#define PDA_PDARI_P4_CON3_REG (0x30c)
#define PDA_PDARI_P4_CON4_REG (0x310)
#define PDA_PDALI_P5_CON0_REG (0x314)
#define PDA_PDALI_P5_CON1_REG (0x318)
#define PDA_PDALI_P5_CON2_REG (0x31c)
#define PDA_PDALI_P5_CON3_REG (0x320)
#define PDA_PDALI_P5_CON4_REG (0x324)
#define PDA_PDARI_P5_CON0_REG (0x328)
#define PDA_PDARI_P5_CON1_REG (0x32c)
#define PDA_PDARI_P5_CON2_REG (0x330)
#define PDA_PDARI_P5_CON3_REG (0x334)
#define PDA_PDARI_P5_CON4_REG (0x338)
#define PDA_PDA_SECURE_1_REG (0x33c)
#define PDA_PDA_SECURE_2_REG (0x340)
#define PDA_PDA_TILE_STATUS_1_REG (0x344)
#define PDA_PDALI_P3_ERR_STAT_REG (0x348)
#define PDA_PDARI_P3_ERR_STAT_REG (0x34c)
#define PDA_PDALI_P4_ERR_STAT_REG (0x350)
#define PDA_PDARI_P4_ERR_STAT_REG (0x354)
#define PDA_PDALI_P5_ERR_STAT_REG (0x358)
#define PDA_PDARI_P5_ERR_STAT_REG (0x35c)
#define PDA_PDALI_P3_BASE_ADDR_MSB_REG (0x360)
#define PDA_PDARI_P3_BASE_ADDR_MSB_REG (0x364)
#define PDA_PDALI_P4_BASE_ADDR_MSB_REG (0x368)
#define PDA_PDARI_P4_BASE_ADDR_MSB_REG (0x374)
#define PDA_PDALI_P5_BASE_ADDR_MSB_REG (0x378)
#define PDA_PDARI_P5_BASE_ADDR_MSB_REG (0x37c)
...
#define PDA_PDA_P4_AXSLC_REG (0x394)
#define PDA_PDA_P5_AXSLC_REG (0x398)
#define PDA_PDAO_P1_AXSLC_REG (0x39c)
#define PDA_PDA_PSUEDO_MODE_EN_REG (0x3a0)
...
#define PDA_PDA_DL_CTRL_REG (0x3bc)
#define PDA_PDA_P1_SLC_GID_REG (0x3c0)
#define PDA_PDA_P2_SLC_GID_REG (0x3c4)
#define PDA_PDA_P3_SLC_GID_REG (0x3c8)
#define PDA_PDA_P4_SLC_GID_REG (0x3cc)
#define PDA_PDA_P5_SLC_GID_REG (0x3d0)
#define PDA_PDAO_P1_SLC_GID_REG (0x3d4)
