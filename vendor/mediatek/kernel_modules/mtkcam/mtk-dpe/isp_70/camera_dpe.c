...
void DPE_DumpUserSpaceReg(struct DPE_Kernel_Config *pDpeConfig)
{
	...
	LOG_INF("DVS_ME_25 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_25);
	LOG_INF("DVS_ME_26 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_26);
	LOG_INF("DVS_ME_27 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_27);
	LOG_INF("DVS_ME_28 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_28);
	LOG_INF("DVS_ME_29 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_29);
	LOG_INF("DVS_ME_30 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_30);
	LOG_INF("DVS_ME_31 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_31);
	LOG_INF("DVS_ME_32 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_32);
	LOG_INF("DVS_ME_33 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_33);
	LOG_INF("DVS_ME_34 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_34);
	LOG_INF("DVS_ME_35 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_35);
	LOG_INF("DVS_ME_36 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_36);
	LOG_INF("DVS_ME_37 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_37);
	LOG_INF("DVS_ME_38 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_38);
	LOG_INF("DVS_ME_39 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_39);
	LOG_INF("DVS_ME_37 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_37);
	LOG_INF("DVS_ME_38 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_38);
	LOG_INF("DVS_ME_39 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_39);

	LOG_INF("DVS_DEBUG = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_DEBUG);
	LOG_INF("DVS_ME_RESERVED = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_RESERVED);
	LOG_INF("DVS_ME_ATPG = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_ATPG);
	LOG_INF("DVS_ME_40 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_40);
	LOG_INF("DVS_ME_41 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_41);
	...
	LOG_INF("DVS_OCC_PQ_6 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_6);
	LOG_INF("DVS_OCC_PQ_7 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_7);
	LOG_INF("DVS_OCC_PQ_8 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_8);
	LOG_INF("DVS_OCC_PQ_9 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_9);
	LOG_INF("DVS_OCC_PQ_10 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_10);
	LOG_INF("DVS_OCC_PQ_11 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_11);
	LOG_INF("DVS_OCC_ATPG = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_ATPG);
	...
	LOG_INF("DVP_CORE_16 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_16);
