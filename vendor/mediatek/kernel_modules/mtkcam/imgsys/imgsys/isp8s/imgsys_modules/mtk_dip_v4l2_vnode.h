...
static const struct mtk_imgsys_video_device_desc dip_setting[] = {
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_CSMCSI_D2_OUT,
		.name = "Csmcsi2 Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_CSMCBI_D1_OUT,
		.name = "Csmcbi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 22,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Color CSWb input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_CSMCCI_D1_OUT,
		.name = "Csmcci Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 23,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Color CSWc input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_CSMCDI_D1_OUT,
		.name = "Csmcdi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 24,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Color CSWd input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_TNCCSI_OUT,
		.name = "Tnccsi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 25,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Tnccsi in",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_RACWI_OUT,
		.name = "Racwi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 26,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Racwi in",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_LMEI_OUT,
		.name = "Lmei Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_RACCSI_OUT,
		.name = "Raccsi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 28,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Raccsi in",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_RACWSI_OUT,
		.name = "Racwsi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 29,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Racwsi in",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_FPNRCSI_OUT,
		.name = "Fpnrcsi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 30,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Fpnrcsi in",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_VDCECSI_OUT,
		.name = "Vdcecsi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 31,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Vdcecsi in",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_VDCELFI_OUT,
		.name = "Vdcelfi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_CSMCSO_D2_CAPTURE,
		.name = "Csmcso2 Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 11,
		.frmsizeenum = &dip_out_frmsizeenum,
		.description = "Color CSS2 output",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_LMEO_CAPTURE,
		.name = "Lmeo Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 12,
		.frmsizeenum = &dip_out_frmsizeenum,
		.description = "Lmeo output",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_RACWO_CAPTURE,
		.name = "Racwo Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 13,
		.frmsizeenum = &dip_out_frmsizeenum,
		.description = "Racwo output",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_RACWSO_CAPTURE,
		.name = "Racwso Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
