...
#define TRAW_DMA_DBG_SEL	 (0x4034)
#define TRAW_DMA_DBG_PORT	 (0x4038)
...
#define DRZH2N_T3_DBG_SEL	 (0xB2F4)
#define DRZH2N_T3_DBG_RDATA	 (0xB300)
#define DRZH2N_T5_DBG_SEL	 (0xB3F4)
#define DRZH2N_T5_DBG_RDATA	 (0xB400)
#define TRAW_UNP_T2_SEL	     (0x8218)
#define TRAW_UNP_T2_OUT	     (0x821C)
#define TRAW_UNP_T3_SEL	     (0x8258)
#define TRAW_UNP_T3_OUT	     (0x825C)
#define TRAW_PAK_T2_SEL	     (0xA5D0)
#define TRAW_PAK_T2_OUT	     (0xA5D4)
#define TRAW_PAK_T3_SEL	     (0xA610)
#define TRAW_PAK_T3_OUT	     (0xA614)
#define TRAW_PLNW_T1_SEL	 (0xA550)
#define TRAW_PLNW_T1_OUT	 (0xA554)
...
#define TRAW_CQ_DESC_NUM 180 // align with userspace
