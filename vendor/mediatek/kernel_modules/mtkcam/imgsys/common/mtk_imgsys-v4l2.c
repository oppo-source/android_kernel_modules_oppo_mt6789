...
int imgsys_clr_dbgtop_en;
module_param(imgsys_clr_dbgtop_en, int, 0644);
...
bool imgsys_clear_dbgtop_enable(void)
{
	return imgsys_clr_dbgtop_en;
}
EXPORT_SYMBOL(imgsys_clear_dbgtop_enable);
