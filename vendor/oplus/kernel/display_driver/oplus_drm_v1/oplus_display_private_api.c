...
int panel_serial_number_read(struct drm_crtc *crtc, char cmd, int num)
{
	...
	if ((!strcmp(panel_name, "oplus22823_tm_nt37705_fhd_dsi_cmd"))
		...
		oplus_ddic_dsi_send_cmd(sizeof(page_1), page_1);
	}
	if (!strcmp(panel_name, "ac124_p_3_a0004_cmd_panel") || !strcmp(panel_name, "ac160_p_3_a0004_cmd_panel")) {
		pr_info("[oplus]a0004 set page1D\n");
		oplus_ddic_dsi_send_cmd(sizeof(page_1D), page_1D);
	}

	if (!strcmp(panel_name, "ac242_p_1_a0017_fhd_vdo")) {
		pr_info("ac242_p_1_a0017_fhd_vdo set page0\n");
		oplus_ddic_dsi_send_cmd(sizeof(samsung_page0), samsung_page0);
	}

	if (!strcmp(panel_name, "ac386_p_3_a0025_vdo_panel")) {
		pr_info("ac386_p_3_a0025_vdo_panel set page0\n");
		oplus_ddic_dsi_send_cmd(sizeof(BL4_NT37703A), BL4_NT37703A);
	}
	while (count > 0) {
		...
		} else if ((!strcmp(panel_name, "ac386_p_3_a0025_vdo_panel"))) {
			panel_serial_info.reg_index = 0;
	...
	if (!strcmp(panel_name, "ac124_p_3_a0004_cmd_panel") || !strcmp(panel_name, "ac160_p_3_a0004_cmd_panel")) {
		...
		oplus_ddic_dsi_send_cmd(sizeof(page_00), page_00);
	}
	...
	if (!strcmp(panel_name, "ac124_p_3_a0004_cmd_panel")) {
		...
		oplus_ddic_dsi_send_cmd(sizeof(page_20), page_20);
	}
	if (!strcmp(panel_name, "ac242_p_1_a0017_fhd_vdo")) {
		pr_info("ac242_p_1_a0017_fhd_vdo set page1\n");
		oplus_ddic_dsi_send_cmd(sizeof(samsung_page1), samsung_page1);
	}
...
int panel_serial_number_read_for_ilitek(void)
{
	...
	while (count > 0) {
		oplus_ddic_dsi_send_cmd(sizeof(page_f), page_f);
	...
	oplus_ddic_dsi_send_cmd(sizeof(page_0), page_0);
...
void oplus_sync_panel_brightness(struct drm_crtc *crtc)
{
	...
	mtk_drm_trace_begin("sync_panel_brightness level(%d) sync(%d)",
		mtk_crtc->oplus_apollo_br->oplus_pending_backlight, mtk_crtc->oplus_apollo_br->oplus_backlight_need_sync);
