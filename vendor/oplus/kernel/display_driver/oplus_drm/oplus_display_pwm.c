...
#ifdef OPLUS_DISPLAY_FEATURE_DMR
	oplus_display_demura_binset_by_mode(crtc, enabled);
#endif /* demura*/
	return 0;
}
#ifdef OPLUS_DISPLAY_FEATURE_DMR
int oplus_display_demura_binset_by_mode(struct drm_crtc *crtc, unsigned int bl_mode)
{
	...
	mtk_drm_set_dbv_mode(crtc, bl_mode);
