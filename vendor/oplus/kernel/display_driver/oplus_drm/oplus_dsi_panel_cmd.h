...
extern int oplus_dsi_panel_send_cmd_v1(void *dsi, enum dsi_cmd_id cmd_set_id, struct dsi_cmd_table *table,
		void *handle, enum dsi_cmd_set_state cmd_state, enum dsi_cmd_func cmd_func, unsigned int count);
extern int oplus_dsi_panel_send_cmd_v2(void *dsi, enum dsi_cmd_id cmd_set_id, struct dsi_cmd_table *table,
