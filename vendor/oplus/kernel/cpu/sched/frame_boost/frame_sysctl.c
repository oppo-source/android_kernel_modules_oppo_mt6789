...
static int input_boost_ctrl_handler(const struct ctl_table *table, int write, void __user *buffer,
...
static int slide_boost_ctrl_handler(const struct ctl_table *table, int write, void __user *buffer,
	size_t *lenp, loff_t *ppos)
{
	int result;
...
static int fps_data_ctrl_handler(const struct ctl_table *table, int write, void __user *buffer,
	size_t *lenp, loff_t *ppos)
{
	int ret, cnt = 0;
