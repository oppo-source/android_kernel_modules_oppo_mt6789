...
static void set_multi_shutter_frame_length(struct subdrv_ctx *ctx,
                u64 *shutters, kal_uint16 shutter_cnt,
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, struct mtk_hdr_ae *ae_ctrl)
{
    ...
    case SENSOR_SCENARIO_ID_CUSTOM7:
    {
        ...
        if (ae_ctrl) {
            LOG_INF("call SENSOR_SCENARIO_ID_CUSTOM7 %llu %u",
                    ae_ctrl->exposure.le_exposure, ae_ctrl->gain.le_gain);
            set_shutter_w_gph(ctx, ae_ctrl->exposure.le_exposure, KAL_FALSE);
            set_gain_w_gph(ctx, ae_ctrl->gain.le_gain, KAL_FALSE);
        }
        FMC_GPH_END;
    }
        break;
    case SENSOR_SCENARIO_ID_CUSTOM8:
    {
        ...
        if (ae_ctrl) {
            LOG_INF("call SENSOR_SCENARIO_ID_CUSTOM8 %llu %llu %u %u",
    ...
    case SENSOR_SCENARIO_ID_CUSTOM5:
    {
        ...
        if (ae_ctrl) {
            LOG_INF("call SENSOR_SCENARIO_ID_custom5 %llu %u",
                    ae_ctrl->exposure.le_exposure, ae_ctrl->gain.le_gain);
            set_shutter_w_gph(ctx, ae_ctrl->exposure.le_exposure, KAL_FALSE);
            set_gain_w_gph(ctx, ae_ctrl->gain.le_gain, KAL_FALSE);
        }
...
#define EEPROM_8k 0x8000
    ...
    case SENSOR_FEATURE_GET_SEAMLESS_SCENARIOS:
        ...
        LOG_DEBUG("SENSOR_FEATURE_GET_SEAMLESS_SCENARIOS %llu %u\n", *feature_data, *pScenarios);
        break;
