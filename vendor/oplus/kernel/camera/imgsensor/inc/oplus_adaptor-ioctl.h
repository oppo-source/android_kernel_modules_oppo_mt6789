...
static int g_get_unique_id(struct adaptor_ctx *ctx, void *arg)
{
	struct oplus_distortion_data *info = arg;
...
static int g_get_otp_initsetting_info(struct adaptor_ctx *ctx, void *arg)
{
	int *info = arg;
...
static const struct ioctl_entry oplus_ioctl_list[] = {
	...
	{VIDIOC_MTK_G_SENSOR_UNIQUE_ID, g_get_unique_id},
	{VIDIOC_MTK_G_OTP_INITSETIING_INFO, g_get_otp_initsetting_info},
};
