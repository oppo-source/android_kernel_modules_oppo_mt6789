...
#include "ak7316m_24085.h"
#include <soc/oplus/system/oplus_project.h>

#define DRIVER_NAME "ak7316m_24085"
#define LOG_INF(format, args...)                                               \
	pr_info(DRIVER_NAME " [%s] " format, __func__, ##args)

#define AK7316M_NAME				"ak7316m_24085"
...
static int ak7316m_init(struct ak7316m_device *ak7316m)
{
	...
	ak7316m_set_position(ak7316m, g_last_pos);
	LOG_INF("g_last_pos = %d", g_last_pos);
...
static int ak7316m_probe(struct i2c_client *client)
{
	...
	if ((24085 == prj_id) || (24087 == prj_id)
		|| (24203 == prj_id) || (24204 == prj_id)) {
...
static const struct of_device_id ak7316m_of_table[] = {
	{ .compatible = "oplus,ak7316m_24085" },
	{ },
};
