...
static unsigned int do_single_lsc_hhmain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_hhmain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_hhmain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_pdaf_hhmain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x015E012C, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00004000, 0x0000074C, do_single_lsc_hhmain},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_hhmain}, //Start address, block size is useless
		{0x00000001, 0x00005300, 0x00001648, do_pdaf_hhmain},
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_hhmain}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT hhmain_op_eeprom = {
	.name = "hhmain_op_eeprom",
