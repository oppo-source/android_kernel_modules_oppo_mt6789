...
static unsigned int range_max_qp[15] = {4, 4, 5, 6, 7, 7, 7, 8, 9, 10, 11, 12, 13, 13, 13};
...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	tianma_dcs_write_seq_static(ctx, 0xB1, 0x2C, 0xAB, 0xAB, 0x27, 0xE7, 0x11, 0x9B,
		0x11, 0x36, 0x36, 0x36, 0x36, 0x2A, 0x8B, 0x11,
		0x65, 0x00, 0x88, 0xFA, 0xFF, 0xFF, 0x8F, 0xFF,
		0x08, 0xFF, 0x33);
	tianma_dcs_write_seq_static(ctx, 0xB2, 0x00, 0x47, 0xB0, 0xD0, 0x00, 0x12, 0xCE,
		0x3C, 0x36, 0x01, 0x02, 0x00, 0x00, 0x88, 0x15,
		0x25, 0x87, 0x00, 0x00, 0x00, 0x13, 0x50, 0xA0);
	tianma_dcs_write_seq_static(ctx, 0xB4, 0x1C, 0x2B, 0x1C, 0x2B, 0x1C, 0x2B, 0x03,
		0x43, 0x03, 0x43, 0x01, 0x4B);
	tianma_dcs_write_seq_static(ctx, 0xBC, 0x1B, 0x04);
	tianma_dcs_write_seq_static(ctx, 0xBE, 0x20);
	tianma_dcs_write_seq_static(ctx, 0xBF, 0xFC, 0x84, 0x80, 0x9C, 0x36, 0x00, 0x0D,
		0x04);
	tianma_dcs_write_seq_static(ctx, 0xC0, 0x34, 0x34, 0x22, 0x11, 0x22, 0xA0, 0x61,
		0x08, 0xF5, 0x03);
	tianma_dcs_write_seq_static(ctx, 0xC2, 0x43, 0xFF, 0x00);
	tianma_dcs_write_seq_static(ctx, 0xE9, 0xCC);
	tianma_dcs_write_seq_static(ctx, 0xC7, 0x80, 0x03, 0xB2, 0x04, 0x60, 0x10, 0x80,
		0x20, 0x40);
	...
	tianma_dcs_write_seq_static(ctx, 0xD3, 0x06, 0x00, 0x00, 0x00, 0xC0, 0x07, 0x08,
		0x07, 0x08, 0x03, 0x03, 0x22, 0x23, 0x11, 0x11,
		0x03, 0x03, 0x32, 0x10, 0x0F, 0x00, 0x0F, 0x32,
		0x10, 0x10, 0x00, 0x10, 0x32, 0x10, 0x10, 0x00,
		0x10, 0x00, 0x00);
	tianma_dcs_write_seq_static(ctx, 0xD5, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
		0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
		0x18, 0x18, 0x18, 0x40, 0x40, 0x41, 0x41, 0x18,
		0x18, 0x00, 0x00, 0x02, 0x02, 0x01, 0x01, 0x03,
		0x03, 0x41, 0x41, 0x41, 0x41, 0x20, 0x20, 0x18,
		0x18, 0x18, 0x18, 0x18, 0x18);
	tianma_dcs_write_seq_static(ctx, 0xD6, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
		0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
		0x18, 0x18, 0x18, 0x40, 0x40, 0x18, 0x18, 0x41,
		0x41, 0x01, 0x01, 0x03, 0x03, 0x00, 0x00, 0x02,
		0x02, 0x41, 0x41, 0x41, 0x41, 0x20, 0x20, 0x18,
		0x18, 0x18, 0x18, 0x18, 0x18);
	tianma_dcs_write_seq_static(ctx, 0xD8, 0xAA, 0xAA, 0xBA, 0xAA, 0xAA, 0xA0, 0xAA,
		0xAA, 0xBA, 0xAA, 0xAA, 0xA0, 0xAA, 0xAA, 0xAE,
		0xFF, 0xAA, 0xA0, 0xAA, 0xAA, 0xAE, 0xFF, 0xAA,
		0xA0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00);
	tianma_dcs_write_seq_static(ctx, 0xE0, 0x00, 0x04, 0x0D, 0x13, 0x19, 0x28, 0x44,
		0x4C, 0x54, 0x50, 0x6C, 0x72, 0x79, 0x8A, 0x8A,
		0x93, 0x9D, 0xB0, 0xB0, 0x56, 0x5D, 0x66, 0x6C,
		0x00, 0x04, 0x0D, 0x13, 0x1B, 0x2F, 0x47, 0x4C,
		0x54, 0x50, 0x6C, 0x72, 0x79, 0x8A, 0x8A, 0x93,
		0x9D, 0xB0, 0xB0, 0x56, 0x5D, 0x66, 0x6C);
	tianma_dcs_write_seq_static(ctx, 0xE1, 0x12, 0x00, 0x00, 0x89, 0x30, 0x80, 0x07,
		0xD0, 0x02, 0x58, 0x00, 0x14, 0x02, 0x58, 0x02,
		0x58, 0x02, 0x00, 0x02, 0x2C, 0x00, 0x20, 0x02,
		0x02, 0x00, 0x08, 0x00, 0x0C, 0x05, 0x0E, 0x04,
		0x94, 0x18, 0x00, 0x10, 0xF0, 0x03, 0x0C, 0x20,
		0x00, 0x06, 0x0B, 0x0B, 0x33, 0x0E, 0x1C, 0x2A,
		0x38, 0x46, 0x54, 0x62, 0x69, 0x70, 0x77, 0x79,
		0x7B, 0x7D, 0x7E, 0x01, 0x02, 0x01, 0x00, 0x09);
	tianma_dcs_write_seq_static(ctx, 0xE7, 0x2D, 0x08, 0x08, 0x40, 0x44, 0x4C, 0x01,
		0xD2, 0x4B, 0x14, 0x14, 0x00, 0x00, 0x00, 0x00,
		0x12, 0x05, 0x02, 0x02, 0x08, 0x33, 0x03, 0x84,
		0x18, 0x01);
	tianma_dcs_write_seq_static(ctx, 0xBD, 0x01);
	tianma_dcs_write_seq_static(ctx, 0xE1, 0x40, 0x09, 0xBE, 0x19, 0xFC, 0x19, 0xFA,
		0x19, 0xF8, 0x1A, 0x38, 0x1A, 0x78, 0x1A, 0xB6,
		0x2A, 0xF6, 0x2B, 0x34, 0x2B, 0x74, 0x3B, 0x74,
		0x6B, 0x74);
	tianma_dcs_write_seq_static(ctx, 0xE2, 0x1C, 0x2B, 0x1C, 0x2B, 0x1C, 0x2B, 0x03,
		0x43, 0x03, 0x43, 0x04, 0x68, 0x01, 0x4B, 0x03,
		0x05, 0x20, 0x05, 0x07, 0x00, 0x00, 0x0F, 0x0F,
		0x0F, 0x0F, 0x00, 0x00, 0x00, 0x2B, 0x0E, 0x0E,
		0x3E, 0x44, 0x4D, 0x01, 0xF8, 0x4F, 0x14, 0x14,
		0x00, 0x00, 0xD0, 0x01, 0x34, 0x47, 0x36, 0x48,
		0x00, 0x20, 0x4B, 0x00, 0x36, 0x00, 0x07, 0x03,
		0x00);
	tianma_dcs_write_seq_static(ctx, 0xB1, 0x01, 0xB6, 0x11);
	tianma_dcs_write_seq_static(ctx, 0xCB, 0x86);
	tianma_dcs_write_seq_static(ctx, 0xD8, 0xAA, 0xAA, 0xAE, 0x00, 0xF0, 0xA0, 0xAA,
		0xAA, 0xAE, 0x00, 0xF0, 0xA0, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00);
	tianma_dcs_write_seq_static(ctx, 0xE7, 0x02, 0x00, 0xC0, 0x01, 0x15, 0x07, 0x9A,
		0x08, 0xA0, 0x04, 0x03, 0x77, 0x00, 0x00, 0x00);
	tianma_dcs_write_seq_static(ctx, 0xBD, 0x02);
	tianma_dcs_write_seq_static(ctx, 0xE2, 0x1C, 0x2B, 0x1C, 0x2B, 0x1C, 0x2B, 0x03,
		0x43, 0x03, 0x43, 0x04, 0x68, 0x01, 0x4B, 0x03,
		0x05, 0x20, 0x05, 0x07, 0x00, 0x00, 0x0F, 0x0F,
		0x0F, 0x0F, 0x00, 0x00, 0x00, 0x0A, 0x1C, 0x1C,
		0x1D, 0x50, 0x48, 0x01, 0xEF, 0x86, 0x14, 0x14,
		0x00, 0x00, 0x34, 0x01, 0x34, 0x47, 0x44, 0x48,
		0x00, 0x20, 0x4B, 0x00, 0x36, 0x00, 0x07, 0x03,
		0x00);
	tianma_dcs_write_seq_static(ctx, 0xBF, 0xF2);
	tianma_dcs_write_seq_static(ctx, 0xD8, 0xAA, 0xAA, 0xEA, 0xAA, 0xFA, 0xA0, 0xAA,
		0xAA, 0xEA, 0xAA, 0xFA, 0xA0);
	tianma_dcs_write_seq_static(ctx, 0xE7, 0x01, 0x04, 0x01, 0x04, 0x01, 0x04, 0x03,
		0x03, 0x03, 0x03, 0x00, 0x03, 0x81, 0x02, 0x40,
		0x00, 0x20, 0x4B, 0x02, 0x01);
	tianma_dcs_write_seq_static(ctx, 0xBD, 0x03);
	tianma_dcs_write_seq_static(ctx, 0xD8, 0xAA, 0xAA, 0xBF, 0xAA, 0xAA, 0xA0, 0xAA,
		0xAA, 0xBF, 0xAA, 0xAA, 0xA0, 0xAA, 0xAA, 0xEA,
		0xAA, 0xFA, 0xA0, 0xAA, 0xAA, 0xEA, 0xAA, 0xFA,
		0xA0, 0xAA, 0xAA, 0xEF, 0xAA, 0xFA, 0xA0, 0xAA,
		0xAA, 0xEF, 0xAA, 0xFA, 0xA0);
