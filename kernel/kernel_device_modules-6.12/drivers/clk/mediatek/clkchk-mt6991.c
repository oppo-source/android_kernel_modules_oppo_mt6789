...
static struct regname rn[] = {
	...
	REGNAME(mm_hwv, 0x1434, HW_CCF_BACKUP1_STATUS),
	REGNAME(mm_hwv, 0x1430, HW_CCF_BACKUP1_ENABLE),
	REGNAME(mm_hwv, 0x1484, HW_CCF_BACKUP1_SET_STATUS),
	REGNAME(mm_hwv, 0x1488, HW_CCF_BACKUP1_CLR_STATUS),
	REGNAME(mm_hwv, 0x0230, HW_CCF_BACKUP1_XPU0_SET),
	REGNAME(mm_hwv, 0x10230, HW_CCF_BACKUP1_XPU1_SET),
	REGNAME(mm_hwv, 0x20230, HW_CCF_BACKUP1_XPU2_SET),
	REGNAME(mm_hwv, 0x30230, HW_CCF_BACKUP1_XPU3_SET),
	REGNAME(mm_hwv, 0x40230, HW_CCF_BACKUP1_XPU4_SET),
