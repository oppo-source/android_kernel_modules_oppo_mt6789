...
#define PERI_AO_BCRM_BASE    0x11031000
...
#define VDNR_DCM_TOP_INFRA_PAR_BUS_u_INFRA_PAR_BUS_CTRL_3 (INFRA_AO_BCRM_BASE + 0x40)
#define VDNR_DCM_TOP_PERI_PAR_BUS_u_PERI_PAR_BUS_CTRL_0   (PERI_AO_BCRM_BASE + 0x48)
#define VDNR_DCM_TOP_PERI_PAR_BUS_u_PERI_PAR_BUS_CTRL_1   (PERI_AO_BCRM_BASE + 0x4c)
#define VDNR_DCM_TOP_PERI_PAR_BUS_u_PERI_PAR_BUS_CTRL_2   (PERI_AO_BCRM_BASE + 0x50)
