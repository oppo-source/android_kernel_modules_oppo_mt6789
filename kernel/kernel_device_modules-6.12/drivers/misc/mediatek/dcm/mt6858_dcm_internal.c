...
#define DCM_NODE "mediatek,mt6858-dcm"
...
static int __init mt6858_dcm_init(void)
{
	int ret = 0;
...
static void __exit mt6858_dcm_exit(void)
{
}
MODULE_SOFTDEP("pre:mtk_dcm.ko");
module_init(mt6858_dcm_init);
module_exit(mt6858_dcm_exit);
