...
#define R12_AUDIO_IRQ_SOUNDWIRE_ADDA_B  (1U << 17)
...
#define R12_GIP2SPM_M_WAKE              (1U << 31)

//-- MD32PCM_STA4 define
#define R12_H_GIP2SPM_P_WAKEUP          (0x1U << 0)
#define R12_H_ERROR_FLAG_WDT_IRQ_B      (0x1U << 1)
#define R12_H_SPM_ACK_CHK_WAKEUP        (0x1U << 2)
#define R12_H_OCLA2SPM_IRQ_B            (0x1U << 3)
#define R12_H_VLP_HWCCF_IRQ_B           (0x1U << 4)
#define R12_H_MM_HWCCF_IRQ_B            (0x1U << 5)
