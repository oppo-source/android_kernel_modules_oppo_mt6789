...
#define SPM_FLAG_ENABLE_LVTS_WORKAROUND          (1U << 4)
...
#define SPM_FLAG_ENABLE_MD_MUMTAS                (1U << 22)
...
#define SPM_FLAG1_POLLING_BUS_PROTECT            (1U << 9)
...
#define SPM_FLAG1_DO_DPSW_0P725V                 (1U << 15)
