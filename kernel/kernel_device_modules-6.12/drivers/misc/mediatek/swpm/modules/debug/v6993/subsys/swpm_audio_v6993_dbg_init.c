...
void __exit swpm_audio_v6993_dbg_exit(void)
{
	swpm_audio_v6993_exit();
}

module_init(swpm_audio_v6993_dbg_init);
module_exit(swpm_audio_v6993_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6993 SWPM audio debug module");
