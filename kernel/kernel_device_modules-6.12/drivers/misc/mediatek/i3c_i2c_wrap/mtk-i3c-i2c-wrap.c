...
int mtk_i3c_dev_find_i2c_dev_by_addr(struct i3c_i2c_device *i3c_i2c_dev,
	u16 static_addr, struct i3c_i2c_device *i3c_i2c_vir_dev)
{
	struct i3c_master_controller *master = NULL;
	struct i2c_dev_desc *i2c_desc = NULL;
	struct i2c_client *i2c_vir_client = NULL;

	if (!i3c_i2c_dev || !i3c_i2c_vir_dev) {
		pr_info("[%s][%s] i3c_i2c_dev or i3c_i2c_vir_dev is NULL\n",
			WRAP_INFO, __func__);
		return -EINVAL;
	}
...
int mtk_i3c_i2c_new_client_device(struct i3c_i2c_device *i3c_i2c_dev,
	u16 static_addr, u8 lvr, struct i3c_i2c_device *i3c_i2c_vir_dev)
{
