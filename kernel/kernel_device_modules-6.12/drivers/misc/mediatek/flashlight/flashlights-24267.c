...
static int milkways3_i2c_probe(struct i2c_client *client)
{
...
static void milkways3_i2c_remove(struct i2c_client *client)
{
...
static void milkways3_remove(struct platform_device *dev)
{
	pr_info("Remove start.\n");
