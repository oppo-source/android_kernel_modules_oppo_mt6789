...
int wusb3801_get_alert_status_and_mask(struct tcpc_device *tcpc, uint32_t *alert, uint32_t *mask)
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 12, 0))
	.get_alert_status_and_mask = wusb3801_get_alert_status_and_mask,
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 12, 0))
static void wusb3801_i2c_remove(struct i2c_client *client)
#else
