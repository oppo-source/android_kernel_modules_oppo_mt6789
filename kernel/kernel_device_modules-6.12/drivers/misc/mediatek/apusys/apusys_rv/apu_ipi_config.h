...
static const struct {
	...
	unsigned int ack:1;
	unsigned int send_ipi_in_rv_handler_max_ost:8;
} ipi_attrs[APU_IPI_MAX] = {
	[APU_IPI_INIT] = { // 0
		.name = "init",
		.direction = IPI_APU_INITIATE,
		.ack = IPI_WITHOUT_ACK,
		.send_ipi_in_rv_handler_max_ost = 0,
	},
	...
	[APU_IPI_PWR_TX] = { // 6
		...
		.direction = IPI_HOST_INITIATE,
		.ack = IPI_WITH_ACK,
		.send_ipi_in_rv_handler_max_ost = 1,
	},
	[APU_IPI_PWR_RX] = { // 7
		.name = "apu-pwr-rx",
		.direction = IPI_APU_INITIATE,
	...
	[APU_IPI_UT] = { // 21
		...
		.direction = IPI_HOST_INITIATE,
		.ack = IPI_WITH_ACK,
		.send_ipi_in_rv_handler_max_ost = 3,
	},
	...
	[APU_IPI_HDS_TX] = { // 26
		.name = "apu-hds-tx-rpmsg",
		.direction = IPI_HOST_INITIATE,
		.ack = IPI_WITH_ACK,
		.send_ipi_in_rv_handler_max_ost = 2,
	},
	[APU_IPI_HDS_RX] = { // 27
		.name = "apu-hds-rx-rpmsg",
		.direction = IPI_APU_INITIATE,
		.ack = IPI_WITH_ACK,
		.send_ipi_in_rv_handler_max_ost = 0,
	},
