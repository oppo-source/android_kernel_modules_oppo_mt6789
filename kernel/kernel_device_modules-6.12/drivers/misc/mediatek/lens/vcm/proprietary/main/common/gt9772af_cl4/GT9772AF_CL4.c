...
#define AF_DRVNAME "GT9772AF_CL4_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long GT9772AF_CL4_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int GT9772AF_CL4_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
	...
	if (*g_pAF_Opened == 2) {
		...
		while (currPosition > 40) {
			...
			LOG_INF("currPosition=%lu ",currPosition);
...
int GT9772AF_CL4_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int GT9772AF_CL4_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int GT9772AF_CL4_GetFileName(unsigned char *pFileName)
{
