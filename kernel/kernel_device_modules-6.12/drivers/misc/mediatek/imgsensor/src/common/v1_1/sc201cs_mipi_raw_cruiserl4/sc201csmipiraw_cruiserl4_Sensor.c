...
#include "sc201csmipiraw_cruiserl4_Sensor.h"
#include "imgsensor_common.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "sc201cs_mipi_cruiserl4"
#define LOG_INF(format, args...)    \
	pr_debug(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
extern void register_imgsensor_deviceinfo(char *name, char *version, u8 module_id);
#define DEVICE_VERSION_C201CS_CRUISERL4    "sc201cs_cruiserl4"
static kal_uint8 deviceInfo_register_value = 0x00;

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC201CS_SENSOR_ID_CRUISERL4,
...
{
	return (((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108)) + SENSOR_ID_OFFSET_CRUISERL4);
}
static void set_max_framerate(UINT16 framerate,kal_bool min_framelength_en)
{
    ...
    LOG_INF("framerate = %d, min framelength = %d\n", framerate,min_framelength_en);
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if (deviceInfo_register_value == 0x00) {
                    ...
                    //register_imgsensor_deviceinfo("Cam_r1", DEVICE_VERSION_C201CS_CRUISERL4, imgsensor_info.module_id);
...
UINT32 SC201CS_MIPI_RAW_CRUISERL4_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
