...
//#define ALGORITHM_SLICE_BY_4

#ifdef ALGORITHM_SLICE_BY_4
/**
 * Static table used for the table_driven implementation.
 * Generated on Tue Apr 23 15:49:14 2024
 ...
 *  - SliceBy       = 4
 */
static const crc_t crc_table[4][256] = {
	{
...
crc_t crc_update(crc_t crc, const void *data, size_t data_len)
{
	...
	while (data_len && (((uintptr_t)(const void *)d) % 4 != 0)) {
		tbl_idx = (crc ^ *d) & 0xff;
