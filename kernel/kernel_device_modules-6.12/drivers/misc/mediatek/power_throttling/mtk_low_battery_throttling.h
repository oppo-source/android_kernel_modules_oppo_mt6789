...
enum LOW_BATTERY_PRIO_TAG {
	...
	LOW_BATTERY_PRIO_APU = 3,
	LOW_BATTERY_PRIO_MD = 4,
	LOW_BATTERY_PRIO_MD5 = 5,
	LOW_BATTERY_PRIO_FLASHLIGHT = 6,
	LOW_BATTERY_PRIO_VIDEO = 7,
	LOW_BATTERY_PRIO_WIFI = 8,
	LOW_BATTERY_PRIO_BACKLIGHT = 9,
	LOW_BATTERY_PRIO_DLPT = 10,
	LOW_BATTERY_PRIO_UFS = 11,
