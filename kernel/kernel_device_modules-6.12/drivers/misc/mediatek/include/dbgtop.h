...
#define MTK_DBGTOP_NONRST1			(0x00000020)
#define MTK_DBGTOP_NONRST2			(0x00000024)
...
extern int mtk_dbgtop_read_non_reset_reg(int reg);
extern int mtk_dbgtop_write_non_reset_reg(int reg, int value);
