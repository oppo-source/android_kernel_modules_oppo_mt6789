...
function set_build_environment_common() {
    ...
    export OPLUS_VND_BUILD_PLATFORM=MT6993
    export BAZEL_DO_NOT_DETECT_CPP_TOOLCHAIN=1
    export KERNEL_VERSION=kernel-6.12
    export OPLUS_PLATFORM_INFO=k6993v1_64
    export KERNEL_BUILD_VARIANT=$1
    ...
    KERNEL_DIR=kernel/kernel_device_modules-${VERSION}
    ...
    dtb_support_list="mt6993"
    dtbo_support_list="mediatek/oplus6993_24081 mediatek/oplus6993_24082 mediatek/oplus6993_24206 mediatek/oplus6993_24085 mediatek/oplus6993_24087 mediatek/oplus6993_24203"
    ...
    DIST_DIR=${KLEAF_OBJ}/dist
    OUTPUT_BASE=${KLEAF_OBJ}/bazel/output_user_root/output_base
    VENDOR_OUTTREE_MODULES_DIR=${OUTPUT_BASE}/execroot/_main/bazel-out/k8-fastbuild/bin/vendor
    VENDOR_INTREE_MODULES_DIR=${OUTPUT_BASE}/execroot/_main/bazel-out/k8-fastbuild/bin/kernel_device_modules-${VERSION}/${KRN_MGK}_modules.user
    VENDOR_ORIGIN_MODULES_DIR=${OUTPUT_BASE}/execroot/_main/bazel-out/k8-fastbuild/bin/
...
function set_build_environment_mt6993() {
    export OPLUS_VND_BUILD_PLATFORM=MT6993
    export DEFCONFIG_OVERLAYS="oplus6993.config"
    export OPLUS_PLATFORM_INFO=k6993v1_64
    export SUPPORT_PLATFORM="mt6991 mt6993 mt6858"
...
function init_build_environment() {
    set_build_environment_common $1
    case $variants_platform in
        mt6993)
            echo "mt6993 path"
            set_build_environment_mt6993
        ;;
...
print_help()
{
    ...
    echo "./kernel/oplus/build/oplus_xxx_xxx.sh mt6993 userdebug"
    echo "user build command"
    echo "./kernel/oplus/build/oplus_xxx_xxx.sh mt6993 user"
    echo ""
}
print_end_help()
{
