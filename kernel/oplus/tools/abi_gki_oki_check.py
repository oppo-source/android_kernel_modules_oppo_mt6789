...
def ddk_ko_check(args, output_dir):
    ...
    check_current_status(ko_built_without_ddk_list, ack_path, ack_log, exclude_file, False)
    print("\nddk ko check end...")
...
def symbols_crc_check(acks, output_dir):
    ...
    for ack in acks:
        ...
        check_current_status(abi_compare_recovery_ko_need_symbol, ack_path, ack_log, exclude_file, False)
