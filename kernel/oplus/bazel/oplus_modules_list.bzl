...
load("@mgk_info//:dict.bzl","OPLUS_FEATURES", "OPLUS_PLATFORM_INFO", "KERNEL_BUILD_VARIANT")
...
COMMON_OPLUS_MODULES_LIST = [
    ...
    "//vendor/oplus/kernel/camera:oplus_camera_tmf8806",
    "//vendor/oplus/kernel/camera:oplus_camera_ois_power",
    "//vendor/oplus/kernel/camera:oplus_camera_ak7316m_24085",
    "//vendor/oplus/kernel/camera:oplus_camera_ak7316t_24085",
    "//vendor/oplus/kernel/camera:oplus_camera_jd5516w_24085",
    "//vendor/oplus/kernel/camera:oplus_camera_dw9827c_24081",
    "//vendor/oplus/kernel/camera:oplus_camera_dw9800s_24081",
    "//vendor/oplus/kernel/camera:oplus_camera_ak7316t_24081",
    "//vendor/oplus/kernel/camera:oplus_camera_dw9827c_23081",
    "//vendor/oplus/kernel/camera:oplus_camera_dw9800s_23081",
    "//vendor/oplus/kernel/camera:oplus_camera_dw9800s_tele_23081",
    "//vendor/oplus/kernel/camera:oplus_camera_dw9800s_23021",
    "//vendor/oplus/kernel/camera:oplus_camera_dw9800s_tele_23021",
    "//vendor/oplus/kernel/camera:oplus_camera_dw9827c_23021",
    "//vendor/oplus/kernel/camera:oplus_camera_jd5516w_23251",
    ...
    "//vendor/oplus/kernel/cpu:oplus_bsp_afs_config",
    ...
    "//vendor/oplus/kernel/charger/bazel:{}_{}_ufcs_class".format(OPLUS_PLATFORM_INFO, KERNEL_BUILD_VARIANT),
    "//vendor/oplus/kernel/charger/bazel:{}_{}_test-kit".format(OPLUS_PLATFORM_INFO, KERNEL_BUILD_VARIANT),
    "//vendor/oplus/kernel/charger/bazel:{}_{}_oplus_chg_v2".format(OPLUS_PLATFORM_INFO, KERNEL_BUILD_VARIANT),
...
def get_overlay_modules_list():
    ...
    if "oplus6993.config" in DEFCONFIG_OVERLAYS:
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/cpu:oplus_freq_qos_arbiter")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/cpu:oplus_bsp_omrg")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/cpu:oplus_slc")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/cpu:oplus_bsp_task_overload")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/cpu:oplus_bsp_smart_freq")
    if "oplus6789.config" in DEFCONFIG_OVERLAYS:
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/charger/bazel:{}_{}_oplus_chg".format(OPLUS_PLATFORM_INFO, KERNEL_BUILD_VARIANT),)
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/charger/bazel:{}_{}_oplus_chg_symbol".format(OPLUS_PLATFORM_INFO, KERNEL_BUILD_VARIANT),)
    if "oplus6895.config" in DEFCONFIG_OVERLAYS:
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/charger/bazel:{}_{}_oplus_chg".format(OPLUS_PLATFORM_INFO, KERNEL_BUILD_VARIANT),)
